					...
					a.jgrid,
					{
						...
						getCellIndex : function(d) {
							...
							d = (!d.is("td") && !d.is("th") ? d
									.closest("td,th") : d)[0];
							if (a.browser.msie)
								return a.inArray(d, d.parentNode.cells);
							return d.cellIndex
						},
						...
						stringToDoc : function(d) {
							...
							return e
									&& e.documentElement
									&& e.documentElement.tagName != "parsererror" ? e
									: null
						},
						parse : function(d) {
						...
						parseDate : function(d, e) {
							...
							if (e && e !== null && e !== undefined) {
								...
								e = e.split(f);
								d = d.split(f);
								var j = a.jgrid.formatter.date.monthNames, b = a.jgrid.formatter.date.AmPm, m = function(
										l, n) {
									if (l === 0) {
										if (n == 12)
											n = 0
								...
								for (g = d.length; f < g; f++) {
									...
									if (e[f] !== undefined)
										c[d[f].toLowerCase()] = parseInt(e[f],
												10)
								}
						...
						from : function(d) {
							return new function(e, c) {
								...
								this._getOrder = function(q, r, s, x, A) {
									...
									S = x == "float" || x == "number"
											|| x == "currency"
											|| x == "numeric" ? function(R) {
										R = parseFloat(String(R).replace(m, ""));
										return isNaN(R) ? 0 : R
									}
											: x == "int" || x == "integer" ? function(
													R) {
								...
								this._compareValues = function(q, r, s, x, A) {
									var B;
									B = v ? "jQuery.jgrid.getAccessor(this,'"
											+ r + "')" : "this";
									if (s === undefined)
										s = null;
									var F = s, y = A.stype === undefined ? "text"
											: A.stype;
									if (s !== null)
										switch (y) {
										case "int":
										case "integer":
											F = isNaN(Number(F)) || F === "" ? "0"
													: F;
											B = "parseInt(" + B + ",10)";
											F = "parseInt(" + F + ",10)";
											break;
								...
								this.equals = function(q, r, s) {
									return f._compareValues(f.equals, q, r,
											"==", s)
								};
								...
								this.isNull = function(q, r, s) {
									return f._compareValues(f.equals, q, null,
											"===", s)
								};
								this.greater = function(q, r, s) {
									return f._compareValues(f.greater, q, r,
											">", s)
								};
								this.less = function(q, r, s) {
									return f._compareValues(f.less, q, r, "<",
											s)
								};
								this.greaterOrEquals = function(q, r, s) {
									return f._compareValues(f.greaterOrEquals,
											q, r, ">=", s)
								};
								this.lessOrEquals = function(q, r, s) {
									return f._compareValues(f.lessOrEquals, q,
											r, "<=", s)
								};
								this.startsWith = function(q, r) {
									var s = r === undefined || r === null ? q
											: r;
									s = j ? a.trim(s.toString()).length : s
											.toString().length;
									if (v)
										f
												._append(f
										...
										s = j ? a.trim(r.toString()).length : r
												.toString().length;
										f._append(f._getStr("this")
												+ ".substr(0,"
												+ s
												+ ") == "
												+ f._getStr('"' + f._toStr(q)
														+ '"'))
									}
								...
								this.orderBy = function(q, r, s, x) {
									r = r === undefined || r === null ? "a" : a
											.trim(r.toString().toLowerCase());
									if (s === null || s === undefined)
										s = "text";
									if (x === null || x === undefined)
										x = "Y-m-d";
									if (r == "desc" || r == "descending")
										r = "d";
									if (r == "asc" || r == "ascending")
										r = "a";
									o.push({
										by : q,
										dir : r,
					...
					if (!this.grid) {
						var f = a.extend(true, {
							...
							dragStart : function(u, t, w) {
								...
								this.curGbox = a("#rs_m" + a.jgrid.jqID(f.id),
										"#gbox_" + a.jgrid.jqID(f.id));
								this.curGbox.css({
									display : "block",
									left : w[0],
									top : w[1],
								...
								a.isFunction(f.resizeStart)
										&& f.resizeStart.call(this, t, u);
							...
							dragMove : function(u) {
								if (this.resizing) {
									...
									var w = f.direction === "ltr" ? u.width + t
											: u.width - t, z;
									if (w > 33) {
										this.curGbox.css({
										...
										if (f.forceFit === true) {
											...
											this.newWidth = f.direction === "ltr" ? f.tblwidth
													+ t
													: f.tblwidth - t;
											u.newWidth = w
										}
							...
							dragEnd : function() {
								...
								if (this.resizing) {
									var u = this.resizing.idx, t = this.headers[u].newWidth
											|| this.headers[u].width;
									t = parseInt(t, 10);
									this.resizing = false;
									a("#rs_m" + a.jgrid.jqID(f.id)).css(
											"display", "none");
									...
									if (this.footers.length > 0)
										this.footers[u].style.width = t + "px";
									if (f.forceFit === true) {
										t = this.headers[u + f.nv].newWidth
												|| this.headers[u + f.nv].width;
										this.headers[u + f.nv].width = t;
										this.headers[u + f.nv].el.style.width = t
												+ "px";
										this.cols[u + f.nv].style.width = t
												+ "px";
										if (this.footers.length > 0)
											this.footers[u + f.nv].style.width = t
													+ "px";
										f.colModel[u + f.nv].width = t
									} else {
										f.tblwidth = this.newWidth
												|| f.tblwidth;
										a("table:first", this.bDiv).css(
												"width", f.tblwidth + "px");
										a("table:first", this.hDiv).css(
												"width", f.tblwidth + "px");
										this.hDiv.scrollLeft = this.bDiv.scrollLeft;
										if (f.footerrow) {
											a("table:first", this.sDiv).css(
													"width", f.tblwidth + "px");
											this.sDiv.scrollLeft = this.bDiv.scrollLeft
										}
									}
									a.isFunction(f.resizeStop)
											&& f.resizeStop.call(this, t, u)
								}
								this.curGbox = null;
								document.onselectstart = function() {
									return true
							...
							populateVisible : function() {
								...
								if (u) {
									...
									if (z) {
										...
										var I = Math.round(t.position().top)
												- w, W = I + t.height();
										z *= P;
										var J, O, L;
										if (W < u
												...
												&& (f.lastpage === undefined || parseInt(
														(W + w + z - 1) / z, 10) <= f.lastpage)) {
											O = parseInt((u - W + z - 1) / z,
													10);
											if (W >= 0 || O < 2
													|| f.scroll === true) {
										...
										if (I > 0) {
											J = parseInt(w / z, 10) + 1;
											O = parseInt((w + u) / z, 10) + 2
													- J;
											L = true
										}
										if (O)
											if (!(f.lastpage && J > f.lastpage
													|| f.lastpage == 1 || J === f.page
													&& J === f.lastpage))
												if (g.hDiv.loading)
													g.timer = setTimeout(
															g.populateVisible,
							...
							selectionPreserver : function(u) {
								var t = u.p, w = t.selrow, z = t.selarrrow ? a
										.makeArray(t.selarrrow) : null, D = u.grid.bDiv.scrollLeft, P = t.gridComplete;
								t.gridComplete = function() {
									t.selrow = null;
									t.selarrrow = [];
									if (t.multiselect && z && z.length > 0)
						...
						if (this.tagName.toUpperCase() != "TABLE")
							...
							if (this.p.colNames.length === 0)
								for (h = 0; h < this.p.colModel.length; h++)
									this.p.colNames[h] = this.p.colModel[h].label
											|| this.p.colModel[h].name;
							if (this.p.colNames.length !== this.p.colModel.length)
								alert(a.jgrid.errors.model);
							else {
								var m = a("<div class='ui-jqgrid-view'></div>"), l, n = a.browser.msie ? true
										: false, k = a.browser.webkit
										|| a.browser.safari ? true : false;
								b = this;
								b.p.direction = a.trim(b.p.direction
										.toLowerCase());
								if (a.inArray(b.p.direction, [ "ltr", "rtl" ]) == -1)
									b.p.direction = "ltr";
								j = b.p.direction;
								...
								var o = function(u, t) {
									...
									if (I.hidden === true)
										J += "display:none;";
									if (t === 0)
										J += "width: " + g.headers[u].width
												+ "px;";
									else if (I.cellattr
											&& a.isFunction(I.cellattr))
										if ((u = I.cellattr.call(b, D, w, z, I,
												P))
												&& typeof u === "string") {
											u = u.replace(/style/i, "style")
													.replace(/title/i, "title");
											if (u.indexOf("title") > -1)
												I.title = false;
											if (u.indexOf("class") > -1)
												O = undefined;
											K = u.split("style");
											if (K.length === 2) {
									...
									J += (O !== undefined ? ' class="' + O
											+ '"' : "")
											+ (I.title && w ? ' title="'
													+ a.jgrid.stripHtml(w)
													+ '"' : "");
									J += ' aria-describedby="' + b.p.id + "_"
											+ L + '"';
									return J + K[0]
								}, q = function(u) {
									return u === undefined || u === null
											|| u === "" ? "&#160;"
											: b.p.autoencode ? a.jgrid
													.htmlEncode(u) : u + ""
									...
									if (typeof P.formatter !== "undefined") {
										...
										t = a.isFunction(P.formatter) ? P.formatter
												.call(b, t, u, z, D)
												: a.fmatter ? a.fn
														.fmatter(P.formatter,
																t, u, z, D)
									...
									var z = '<input role="checkbox" type="checkbox" id="jqg_'
											+ b.p.id
											+ "_"
											+ u
									...
									w = (parseInt(w, 10) - 1) * parseInt(z, 10)
											+ 1 + t;
									...
									if (!t || !t.length)
										t = a.map(b.p.colModel, function(w, z) {
											return z
										});
									if (u)
										t = a.map(t, function(w) {
											return w < u ? null : w - u
										});
									return t
								}, y = function(u, t, w) {
									...
									t = b.p.keyIndex === false
											|| b.p.loadonce === true ? b.p.localReader.id
											: b.p.colModel[b.p.keyIndex + w + z
													+ t].name;
									for (w = 0; w < u; w++) {
									...
									var P = new Date, I = b.p.datatype != "local"
											&& b.p.loadonce
											|| b.p.datatype == "xmlstring", W = b.p.datatype == "local" ? "local"
											: "xml";
									if (I) {
										b.p.data = [];
										b.p._index = {};
									...
									if (a.isXMLDoc(u)) {
										if (b.p.treeANode === -1 && !b.p.scroll) {
											...
											w = w > 1 ? w : 1;
										var J, O, L = 0, K, X = 0, ja = 0, ga = 0, ea, ha = [], ra, aa = {}, N, T, $ = [], Da = b.p.altRows === true ? " "
												+ b.p.altclass
												: "";
										b.p.xmlReader.repeatitems
												|| (ha = B(W));
										ea = b.p.keyIndex === false ? b.p.xmlReader.id
												: b.p.keyIndex;
										if (ha.length > 0 && !isNaN(ea)) {
											if (b.p.remapColumns
													&& b.p.remapColumns.length)
												ea = a.inArray(ea,
														b.p.remapColumns);
											ea = ha[ea]
										}
										W = (ea + "").indexOf("[") === -1 ? ha.length ? function(
												ya, ua) {
											return a(ea, ya).text() || ua
												...
												: function(ya, ua) {
													return ya.getAttribute(ea
															.replace(/[\[\]]/g,
																	""))
															|| ua
												};
										b.p.userData = {};
										a(b.p.xmlReader.page, u).each(
												function() {
													b.p.page = this.textContent
															|| this.text || 0
												});
										a(b.p.xmlReader.total, u)
												.each(
														function() {
															b.p.lastpage = this.textContent
																	|| this.text;
															if (b.p.lastpage === undefined)
																b.p.lastpage = 1
														});
										a(b.p.xmlReader.records, u)
												.each(
														function() {
															b.p.records = this.textContent
																	|| this.text
																	|| 0
														});
										a(b.p.xmlReader.userdata, u)
												.each(
														function() {
															b.p.userData[this
										...
										(u = a(b.p.xmlReader.root + " "
												+ b.p.xmlReader.row, u))
												|| (u = []);
										var oa = u.length, sa = 0, Ea = {}, za;
										if (u && oa) {
											za = parseInt(b.p.rowNum, 10);
											var Ga = b.p.scroll ? a.jgrid
													.randId() : 1;
											if (D)
												za *= D + 1;
											D = a
													.isFunction(b.p.afterInsertRow);
											var Fa = "";
											if (b.p.grouping
													&& b.p.groupingView.groupCollapse === true)
											...
											for (; sa < oa;) {
												...
												if (b.p.grouping) {
													...
													for ( var Ha = [], Ia = 0; Ia < J; Ia++)
														Ha
																.push(aa[b.p.groupingView.groupField[Ia]]);
													Ea = a(b).jqGrid(
															"groupingPrepare",
															$, Ha, Ea, aa);
													$ = []
										...
										if (b.p.gridview === true) {
											O = b.p.treeANode > -1 ? b.p.treeANode
													: 0;
											if (b.p.grouping) {
												a(b)
														.jqGrid(
										...
										if (b.p.treeGrid === true)
											try {
												a(b).jqGrid("setTreeNode",
														O + 1, L + O + 1)
											} catch (Ma) {
											}
										if (!b.p.treeGrid && !b.p.scroll)
											b.grid.bDiv.scrollTop = 0;
										b.p.reccount = L;
										b.p.treeANode = -1;
										b.p.userDataOnFooter
												&& a(b).jqGrid("footerData",
														"set", b.p.userData,
														true);
										if (I) {
											b.p.records = oa;
									...
									if (u) {
										if (b.p.treeANode === -1 && !b.p.scroll) {
											...
											w = w > 1 ? w : 1;
										var I, W = b.p.datatype != "local"
												&& b.p.loadonce
												|| b.p.datatype == "jsonstring";
										if (W) {
											b.p.data = [];
											b.p._index = {};
											b.p.localReader.id = "_id_"
										...
										var J = 0, O, L, K = [], X, ja = 0, ga = 0, ea = 0, ha, ra, aa = {}, N, T, $ = [], Da = b.p.altRows === true ? " "
												+ b.p.altclass
												: "";
										b.p.page = a.jgrid.getAccessor(u,
												t.page) || 0;
										ha = a.jgrid.getAccessor(u, t.total);
										b.p.lastpage = ha === undefined ? 1
												: ha;
										b.p.records = a.jgrid.getAccessor(u,
												t.records) || 0;
										b.p.userData = a.jgrid.getAccessor(u,
												t.userdata)
												|| {};
										t.repeatitems || (X = K = B(I));
										I = b.p.keyIndex === false ? t.id
												: b.p.keyIndex;
										...
										(ra = a.jgrid.getAccessor(u, t.root))
												|| (ra = []);
										ha = ra.length;
										u = 0;
										var oa = parseInt(b.p.rowNum, 10), sa = b.p.scroll ? a.jgrid
												.randId()
												: 1;
										if (D)
											oa *= D + 1;
										var Ea = a
												.isFunction(b.p.afterInsertRow), za = {}, Ga = "";
										if (b.p.grouping
												&& b.p.groupingView.groupCollapse === true)
										...
										for (; u < ha;) {
											...
											if (b.p.grouping) {
												...
												for ( var Fa = 0; Fa < O; Fa++)
													L
															.push(aa[b.p.groupingView.groupField[Fa]]);
												za = a(b).jqGrid(
														"groupingPrepare", $,
														L, za, aa);
												$ = []
										...
										if (b.p.gridview === true) {
											N = b.p.treeANode > -1 ? b.p.treeANode
													: 0;
											if (b.p.grouping)
												a(b)
														.jqGrid(
									...
									if (a.isArray(b.p.data)) {
										var O = b.p.grouping ? b.p.groupingView
												: false;
										a
												.each(
														b.p.colModel,
														function() {
															...
															if (!w
																	&& (this.index == b.p.sortname || this.name == b.p.sortname)) {
																t = this.name;
																w = true
															}
														});
										if (b.p.treeGrid)
											a(b).jqGrid("SortTree", t,
													b.p.sortorder, z[t].stype,
													z[t].srcfmt);
										else {
											var L = {
												eq : function(N) {
											...
											if (b.p.search === true) {
												...
												if (X) {
													...
													try {
														K = L[b.p.postData.searchOper]
																(K)
																(
																		b.p.postData.searchField,
																		b.p.postData.searchString,
																		z[b.p.postData.searchField])
													} catch (ja) {
													}
											}
											if (b.p.grouping) {
											...
											if (t && b.p.sortorder && w)
												b.p.sortorder.toUpperCase() == "DESC" ? K
														.orderBy(b.p.sortname,
																"d",
																z[t].stype,
																z[t].srcfmt)
														: K.orderBy(
																...
																z[t].srcfmt);
											X = K.select();
											var ga = parseInt(b.p.rowNum, 10), ea = X.length, ha = parseInt(
													b.p.page, 10), ra = Math
													.ceil(ea / ga), aa = {};
									...
									if (!b.p.hiddengrid)
										switch (b.p.loadui) {
										case "enable":
											a("#load_" + a.jgrid.jqID(b.p.id))
													.show();
											break;
										case "block":
											a("#lui_" + a.jgrid.jqID(b.p.id))
													.show();
											a("#load_" + a.jgrid.jqID(b.p.id))
													.show()
										}
									...
									if (!b.grid.hDiv.loading) {
										...
										if (b.p.page <= 0)
											b.p.page = 1;
										if (D.search !== null)
											w[D.search] = b.p.search;
										if (D.nd !== null)
											w[D.nd] = (new Date).getTime();
										if (D.rows !== null)
											w[D.rows] = b.p.rowNum;
										if (D.page !== null)
											w[D.page] = b.p.page;
										if (D.sort !== null)
											w[D.sort] = b.p.sortname;
										if (D.order !== null)
											w[D.order] = b.p.sortorder;
										if (b.p.rowTotal !== null
												&& D.totalrows !== null)
											w[D.totalrows] = b.p.rowTotal;
										var P = b.p.loadComplete, I = a
												.isFunction(P);
										I || (P = null);
										var W = 0;
										u = u || 1;
										if (u > 1)
											...
											D.npage !== null
													&& delete b.p.postData[D.npage];
										if (b.p.grouping) {
											a(b).jqGrid("groupingSetup");
											if (b.p.groupingView.groupDataSorted === true)
												w[D.sort] = b.p.groupingView.groupField[0]
														+ " "
														+ b.p.groupingView.groupOrder[0]
														+ ", " + w[D.sort]
										}
										...
										if (a.isFunction(b.p.datatype))
											b.p.datatype.call(b, b.p.postData,
													"load_" + b.p.id);
										else {
											a.isFunction(b.p.beforeRequest)
													&& b.p.beforeRequest
															.call(b);
																...
																.extend(
																		{
																			...
																			dataType : z,
																			data : a
																					.isFunction(b.p.serializeGridData) ? b.p.serializeGridData
																					.call(
																							b,
																							b.p.postData)
																					: b.p.postData,
											...
											case "jsonstring":
												ca();
												w = typeof b.p.datastr == "string" ? a.jgrid
														.parse(b.p.datastr)
														: b.p.datastr;
												C(w, b.grid.bDiv);
												I
								...
								l = function(u, t) {
									var w = "", z = "<table cellspacing='0' cellpadding='0' border='0' style='table-layout:auto;' class='ui-pg-table'><tbody><tr>", D = "", P, I, W, J, O = function(
											L) {
										var K;
										if (a.isFunction(b.p.onPaging))
											K = b.p.onPaging.call(b, L);
										b.p.selrow = null;
										if (b.p.multiselect) {
											b.p.selarrrow = [];
									...
									if (b.p.rowList.length > 0) {
										...
										for (I = 0; I < b.p.rowList.length; I++)
											D += '<option role="option" value="'
													+ b.p.rowList[I]
													+ '"'
													+ (b.p.rowNum == b.p.rowList[I] ? ' selected="selected"'
															: "")
													+ ">"
													+ b.p.rowList[I]
													+ "</option>";
									...
									if (b.p.pgbuttons === true) {
										...
										z += w !== "" ? "<td class='ui-pg-button ui-state-disabled' style='width:4px;'><span class='ui-separator'></span></td>"
												+ w
												...
												.click(
														function() {
															var L = o(b.p.page,
																	1), K = o(
																	b.p.lastpage,
																	1), X = false, ja = true, ga = true, ea = true, ha = true;
															if (K === 0
																	|| K === 1)
																ha = ea = ga = ja = false;
															else if (K > 1
									...
									b.p.pginput === true
											&& a("input.ui-pg-input", "#" + P)
													.keypress(
															function(L) {
																if ((L.charCode ? L.charCode
																		: L.keyCode ? L.keyCode
																				: 0) == 13) {
																	b.p.page = a(
																			this)
								...
								var qa = function(u, t, w, z) {
									if (b.p.colModel[t].sortable)
										if (!(b.p.savedRow.length > 0)) {
											if (!w) {
												if (b.p.lastsort == t)
													if (b.p.sortorder == "asc")
														b.p.sortorder = "desc";
													else {
														if (b.p.sortorder == "desc")
															b.p.sortorder = "asc"
													}
												else
													b.p.sortorder = b.p.colModel[t].firstsortorder
															|| "asc";
												b.p.page = 1
											}
											if (z)
											...
											a(
													...
													w).addClass(
													"ui-state-disabled");
											a("tr th:eq(" + b.p.lastsort + ")",
													w).attr("aria-selected",
													"false");
											a(
													"tr th:eq(" + t
															+ ") span.ui-icon-"
											...
											u = u.substring(5);
											b.p.sortname = b.p.colModel[t].index
													|| u;
											w = b.p.sortorder;
											if (a.isFunction(b.p.onSortCol))
												if (b.p.onSortCol.call(b, u, t,
														w) == "stop") {
													b.p.lastsort = t;
													return
												}
											if (b.p.datatype == "local")
												b.p.deselectAfterSort
														&& a(b)
																.jqGrid(
																		"resetSelection");
											else {
									...
									for (t = w[0] = w[1] = w[2] = 0; t <= u; t++)
										if (b.p.colModel[t].hidden === false)
											w[0] += b.p.colModel[t].width + z;
									if (b.p.direction == "rtl")
										w[0] = b.p.width - w[0];
									w[0] -= b.grid.bDiv.scrollLeft;
									if (a(b.grid.cDiv).is(":visible"))
										w[1] += a(b.grid.cDiv).height()
												+ parseInt(a(b.grid.cDiv).css(
														"padding-top"), 10)
												+ parseInt(a(b.grid.cDiv).css(
														"padding-bottom"), 10);
									if (b.p.toolbar[0] === true
											&& (b.p.toolbar[1] == "top" || b.p.toolbar[1] == "both"))
										w[1] += a(b.grid.uDiv).height()
												+ parseInt(a(b.grid.uDiv).css(
														"border-top-width"), 10)
												+ parseInt(a(b.grid.uDiv).css(
														"border-bottom-width"),
														10);
									if (b.p.toppager)
										w[1] += a(b.grid.topDiv).height()
												+ parseInt(
														a(b.grid.topDiv)
																.css(
																		"border-bottom-width"),
														10);
									w[2] += a(b.grid.bDiv).height()
											+ a(b.grid.hDiv).height();
									return w
								};
								this.p.id = this.id;
								if (a.inArray(b.p.multikey, [ "shiftKey",
										"altKey", "ctrlKey" ]) == -1)
									b.p.multikey = false;
								b.p.keyIndex = false;
								for (h = 0; h < b.p.colModel.length; h++) {
									b.p.colModel[h] = a.extend(true, {},
											b.p.cmTemplate,
											b.p.colModel[h].template || {},
											b.p.colModel[h]);
									if (b.p.keyIndex === false
											&& b.p.colModel[h].key === true)
										b.p.keyIndex = h
								}
								...
								va = Y = "";
								if (b.p.shrinkToFit === true
										&& b.p.forceFit === true)
									for (h = b.p.colModel.length - 1; h >= 0; h--)
								...
								Y = "<span class='s-ico' style='display:none'><span sort='asc' class='ui-grid-ico-sort ui-icon-asc"
										...
										+ j + "'></span>";
								Y += "<span sort='desc' class='ui-grid-ico-sort ui-icon-desc"
										+ va
										+ " ui-state-disabled ui-icon ui-icon-triangle-1-s ui-sort-"
										+ j + "'></span></span>";
								for (h = 0; h < this.p.colNames.length; h++) {
									va = b.p.headertitles ? ' title="'
											+ a.jgrid
													.stripHtml(b.p.colNames[h])
											+ '"' : "";
									pa += "<th id='"
											+ b.p.id
											+ "_"
											...
											+ j + "'" + va + ">";
									va = b.p.colModel[h].index
											|| b.p.colModel[h].name;
									pa += "<div id='jqgh_" + b.p.id + "_"
											+ b.p.colModel[h].name + "' " + Ca
											+ ">" + b.p.colNames[h];
									b.p.colModel[h].width = b.p.colModel[h].width ? parseInt(
											b.p.colModel[h].width, 10)
											: 150;
									if (typeof b.p.colModel[h].title !== "boolean")
										b.p.colModel[h].title = true;
									if (va == b.p.sortname)
										b.p.lastsort = h;
									pa += Y + "</div></th>"
								}
								...
								if (this.p.multiselect) {
									var Z = [], da;
									a("#cb_" + a.jgrid.jqID(b.p.id), this)
											.bind(
													"click",
													function() {
														b.p.selarrrow = [];
								...
								(function() {
									...
									if (b.p.shrinkToFit === true && w > 0) {
										...
										if (b.p.tblwidth > b.p.width) {
											b.p.colModel[z].width -= b.p.tblwidth
													- parseInt(b.p.width, 10);
											b.p.tblwidth = b.p.width
										}
									}
								})();
								a(p).css("width", g.width + "px").append(
								...
								a("th", m)
										.each(
												function(u) {
													...
													if (typeof b.p.colModel[u].resizable === "undefined")
														b.p.colModel[u].resizable = true;
													...
													la += "<td role='gridcell' style='height:0px;width:"
															+ E
															+ "px;"
															+ t
															+ "'></td>";
													...
													if (typeof U !== "boolean")
														U = b.p.colModel[u].sortable = true;
												...
												function(u) {
													if (a(u.target)
														...
														if (b.p.forceFit === true) {
															var w = b.p, z = t, D;
															for (D = t + 1; D < b.p.colModel.length; D++)
																if (b.p.colModel[D].hidden !== true) {
																	z = D;
																	break
																}
															w.nv = z - t
								...
								m = a(
										...
										.append(pa);
								var ma = b.p.caption && b.p.hiddengrid === true ? true
										: false;
								...
								a(b)
										...
										.click(
												function(u) {
													...
													var t = a(M).hasClass(
															"cbox"), w = true;
													if (a
															.isFunction(b.p.beforeSelectRow))
														w = b.p.beforeSelectRow
																.call(
																		b,
																		Q[0].id,
																		u);
													if (M.tagName == "A"
															|| (M.tagName == "INPUT"
																	|| M.tagName == "TEXTAREA"
																	|| M.tagName == "OPTION" || M.tagName == "SELECT")
															&& !t)
														return this;
													if (w === true) {
														if (b.p.cellEdit === true)
															if (b.p.multiselect
																	&& t)
																a(b)
																		.jqGrid(
										...
										.bind(
												...
												function(u, t) {
													if (b.p.treeGrid === true)
														b.p.datatype = b.p.treedatatype;
													t
															&& t.current
															&& b.grid
																	.selectionPreserver(b);
													if (b.p.datatype == "local") {
														a(b)
																.jqGrid(
																		"resetSelection");
													...
													if (t && t.page) {
														...
														if (w < 1)
															w = 1;
														b.p.page = w;
														b.grid.bDiv.scrollTop = b.grid.prevRowHeight ? (w - 1)
								...
								a.isFunction(this.p.ondblClickRow)
										&& a(this).dblclick(
												function(u) {
													M = u.target;
													Q = a(M, b.rows).closest(
													...
													ta = a.jgrid
															.getCellIndex(M);
													b.p.ondblClickRow.call(b,
															a(Q).attr("id"),
															ba, ta, u);
													return false
												});
								a.isFunction(this.p.onRightClickRow)
										&& a(this)
												.bind(
														"contextmenu",
														function(u) {
								...
								if (n)
									if (String(b.p.height).toLowerCase() === "auto")
										b.p.height = "100%";
								a(g.bDiv)
										.append(
												a(
														'<div style="position:relative;'
																+ (n
																		&& a.browser.version < 8 ? "height:0.01%;"
																		: "")
																+ '"></div>')
														.append("<div></div>")
														.append(this))
								...
								if (n) {
									a("tbody", this).size() == 2
											&& a("tbody:gt(0)", this).remove();
									b.p.multikey
											&& a(g.bDiv).bind("selectstart",
													function() {
														return false
													})
								} else
									b.p.multikey
											&& a(g.bDiv).bind("mousedown",
													function() {
														return false
													});
								ma && a(g.bDiv).hide();
								g.cDiv = document.createElement("div");
								var na = b.p.hidegrid === true ? a(
								...
								if (b.p.toolbar[0]) {
									...
									if (b.p.toolbar[1] == "top")
										a(g.uDiv).insertBefore(g.hDiv);
									else
										b.p.toolbar[1] == "bottom"
												&& a(g.uDiv)
														.insertAfter(g.hDiv);
									if (b.p.toolbar[1] == "both") {
										...
										a(g.uDiv).width(g.width).addClass(
												"ui-userdata ui-state-default")
												.attr("id", "t_" + this.id);
									ma && a(g.uDiv).hide()
								}
								if (b.p.toppager) {
									b.p.toppager = a.jgrid.jqID(b.p.id)
											+ "_toppager";
									g.topDiv = a("<div id='" + b.p.toppager
											+ "'></div>")[0];
								...
								if (b.p.footerrow) {
									...
									h = a("<div class='ui-jqgrid-hbox"
											+ (j == "rtl" ? "-rtl" : "")
											+ "'></div>");
									a(g.sDiv).append(h).insertAfter(g.hDiv)
											.width(g.width);
									a(h).append(V);
								...
								if (b.p.caption) {
									...
									if (b.p.hidegrid === true) {
										a(".ui-jqgrid-titlebar-close", g.cDiv)
												.click(
														function(u) {
															var t = a
																	.isFunction(b.p.onHeaderClick), w = ".ui-jqgrid-bdiv, .ui-jqgrid-hdiv, .ui-jqgrid-pager, .ui-jqgrid-sdiv", z, D = this;
															if (b.p.toolbar[0] === true) {
																if (b.p.toolbar[1] == "both")
																	w += ", #"
																			+ a(
								...
								a(".ui-jqgrid-labels", g.hDiv).bind(
								...
								b.updatepager = function(u, t) {
									var w, z, D, P, I, W, J, O = "", L = b.p.pager ? "_"
											+ a.jgrid.jqID(b.p.pager.substr(1))
											: "", K = b.p.toppager ? "_"
											+ b.p.toppager.substr(1) : "";
									...
									if (O) {
										...
										if (b.p.pginput === true) {
											...
											P = b.p.toppager ? "#sp_1" + L
													+ ",#sp_1" + K : "#sp_1"
													+ L;
											a(P)
													.html(
															a.fmatter ? a.fmatter.util
																	.NumberFormat(
																			b.p.lastpage,
																			J)
																	: b.p.lastpage)
	...
	a.jgrid
			.extend({
				getGridParam : function(d) {
					var e = this[0];
					if (e && e.grid)
						return d ? typeof e.p[d] != "undefined" ? e.p[d] : null
								: e.p
				},
				setGridParam : function(d) {
					return this.each(function() {
						this.grid && typeof d === "object"
								&& a.extend(true, this.p, d)
					})
				},
				getDataIDs : function() {
					var d = [], e = 0, c, f = 0;
					this.each(function() {
						if ((c = this.rows.length) && c > 0)
							for (; e < c;) {
							...
							.each(function() {
								...
								if (d !== undefined) {
									...
									if (!(!h || h.className
										...
										if (f.p.multiselect) {
											f.p.selrow = h.id;
											j = a.inArray(f.p.selrow,
													f.p.selarrrow);
											if (j === -1) {
												h.className !== "ui-subgrid"
														&& a(h)
																.addClass(
																		"ui-state-highlight")
																.attr(
												...
												j = f.p.selarrrow[0];
												f.p.selrow = j === undefined ? null
														: j
											}
											f.p.onSelectRow
													&& e
													&& f.p.onSelectRow.call(f,
															h.id, g)
										} else if (h.className !== "ui-subgrid") {
											if (f.p.selrow != h.id) {
												a(f.rows.namedItem(f.p.selrow))
														.removeClass(
																"ui-state-highlight")
														.attr(
																{
									...
									if (e.p.multiselect) {
										a(
												"#jqg_" + a.jgrid.jqID(e.p.id)
														+ "_" + a.jgrid.jqID(f))
												.attr("checked", false);
										a("#cb_" + a.jgrid.jqID(e.p.id)).attr(
												"checked", false)
									}
									f = null
								...
								if (e)
									try {
												...
												.each(
														function(v) {
															...
															if (e[f] !== undefined) {
																n[f] = this.formatter
																		&& typeof this.formatter === "string"
																		&& this.formatter == "date" ? a.unformat
																		.date(
																				e[f],
																				this)
																		: e[f];
										...
										if (j.p.datatype == "local") {
											var k = j.p._index[d];
											if (j.p.treeGrid)
												for ( var p in j.p.treeReader)
													n
															.hasOwnProperty(j.p.treeReader[p])
															&& delete n[j.p.treeReader[p]];
											if (typeof k != "undefined")
												j.p.data[k] = a.extend(true,
														j.p.data[k], n);
											n = null
										}
									} catch (o) {
						...
						this
								.each(function() {
									...
									if (!v)
										if (typeof d != "undefined")
											...
											if (this.p.keyIndex !== false) {
												q = this.p.colModel[this.p.keyIndex
														+ b + m + l].name;
												if (typeof e[0][q] != "undefined")
													d = e[0][q]
											}
										}
									r = this.p.altclass;
									for ( var B = 0, F = "", y = {}, G = a
										...
										if (b) {
											p = '<input role="checkbox" type="checkbox" id="jqg_'
													+ this.p.id
													+ "_"
													+ d
													+ '" class="cbox"/>';
											o = this.formatCol(l, 1, "", null,
													d, true);
											j += '<td role="gridcell" aria-describedby="'
													+ this.p.id
													+ '_cb" '
										...
										if (m)
											j += a(this).jqGrid(
													"addSubGridCell", b + l, 1);
										for (k = b + m + l; k < this.p.colModel.length; k++) {
											x = this.p.colModel[k];
											h = x.name;
											y[h] = x.formatter
													&& typeof x.formatter === "string"
													&& x.formatter == "date" ? a.unformat
													.date(s[h], x)
													: s[h];
											p = this.formatter(d, a.jgrid
													.getAccessor(s, h), k, s,
													"edit");
											o = this.formatCol(k, 1, p, d, s,
													true);
											j += '<td role="gridcell" aria-describedby="'
													+ this.p.id
													+ "_"
										...
										if (this.rows.length === 0)
											...
											case "after":
												if (n = this.rows.namedItem(f))
													a(this.rows[n.rowIndex + 1])
															.hasClass(
																	"ui-subgrid") ? a(
															this.rows[n.rowIndex + 1])
															.after(j)
															: a(n).after(j);
												n++;
												break;
				...
				footerData : function(d, e, c) {
					...
					this.each(function() {
						var m = this, l;
						if (!m.grid || !m.p.footerrow)
							return false;
						if (d == "set")
							if (f(e))
								return false;
						h = true;
						a(this.p.colModel).each(
								function(n) {
									g = this.name;
									if (d == "set") {
										if (e[g] !== undefined) {
											l = c ? m.formatter("", e[g], n, e,
													"edit") : e[g];
											b = this.title ? {
												title : a.jgrid.stripHtml(l)
											} : {};
											a("tr.footrow td:eq(" + n + ")",
													m.grid.sDiv).html(l)
													.attr(b);
											h = true
										}
									} else if (d == "get")
										j[g] = a("tr.footrow td:eq(" + n + ")",
												m.grid.sDiv).html()
								})
					});
					return d == "get" ? j : h
				...
				showHideCol : function(d, e) {
					return this.each(function() {
						var c = this, f = false, g = a.browser.webkit
								|| a.browser.safari ? 0 : c.p.cellLayout, h;
						if (c.grid) {
							if (typeof d === "string")
								d = [ d ];
							e = e != "none" ? "" : "none";
							...
							a(this.p.colModel).each(
									function(b) {
										if (a.inArray(this.name, d) !== -1
												&& this.hidden === j) {
											a("tr", c.grid.hDiv).each(
													function() {
														a(this).children(
																"th:eq(" + b
																		+ ")")
							...
							if (f === true)
								if (c.p.shrinkToFit === false)
									a(c).jqGrid("setGridWidth", c.grid.width);
								else
									c.grid.width !== c.p.tblwidth
				...
				remapColumns : function(d, e, c) {
					...
					f(h.p.colNames);
					f(h.grid.headers);
					g(a("thead:first", h.grid.hDiv), c
							&& ":not(.ui-jqgrid-labels)");
					e
							&& g(
									a("#" + a.jgrid.jqID(h.p.id)
											+ " tbody:first"),
									".jqgfirstrow, tr.jqgrow, tr.jqfoot");
					h.p.footerrow && g(a("tbody:first", h.grid.sDiv));
					if (h.p.remapColumns)
						if (h.p.remapColumns.length)
							f(h.p.remapColumns);
						else
							h.p.remapColumns = a.makeArray(d);
					h.p.lastsort = a.inArray(h.p.lastsort, d);
					if (h.p.treeGrid)
						h.p.expColInd = a.inArray(h.p.expColInd, d)
				},
				setGridWidth : function(d, e) {
					return this
							.each(function() {
								if (this.grid) {
									var c = this, f, g = 0, h = a.browser.webkit
											|| a.browser.safari ? 0
											: c.p.cellLayout, j, b = 0, m = false, l = c.p.scrollOffset, n, k = 0, p = 0, o;
									if (typeof e != "boolean")
										e = c.p.shrinkToFit;
									if (!isNaN(d)) {
										d = parseInt(d, 10);
										c.grid.width = c.p.width = d;
										a("#gbox_" + a.jgrid.jqID(c.p.id)).css(
												"width", d + "px");
										a("#gview_" + a.jgrid.jqID(c.p.id))
												.css("width", d + "px");
										a(c.grid.bDiv).css("width", d + "px");
										a(c.grid.hDiv).css("width", d + "px");
										c.p.pager
												&& a(c.p.pager).css("width",
														d + "px");
										c.p.toppager
												&& a(c.p.toppager).css("width",
														d + "px");
										if (c.p.toolbar[0] === true) {
											a(c.grid.uDiv).css("width",
													d + "px");
											c.p.toolbar[1] == "both"
													&& a(c.grid.ubDiv).css(
															"width", d + "px")
										...
										if (e === true) {
											...
											n = d - h * b - k;
											if (!isNaN(c.p.height))
												if (a(c.grid.bDiv)[0].clientHeight < a(c.grid.bDiv)[0].scrollHeight
														|| c.rows.length === 1) {
													m = true;
													n -= l
												}
															...
															function(q) {
																if (this.hidden === false
																	...
																	if (!(f < 0)) {
																		...
																		c.grid.headers[q].el.style.width = f
																				+ "px";
																		if (c.p.footerrow)
																			c.grid.footers[q].style.width = f
																					+ "px";
																		if (v)
																			c.grid.cols[q].style.width = f
																					+ "px";
																		j = q
																	}
																}
											...
											if (c.p.tblwidth > d) {
												...
												f = c.p.colModel[j].width;
											c.grid.headers[j].width = f;
											c.grid.headers[j].el.style.width = f
													+ "px";
											if (v)
												c.grid.cols[j].style.width = f
														+ "px";
											if (c.p.footerrow)
												c.grid.footers[j].style.width = f
														+ "px"
										}
										if (c.p.tblwidth) {
											a("table:first", c.grid.bDiv).css(
													"width",
													c.p.tblwidth + "px");
											a("table:first", c.grid.hDiv).css(
													"width",
													c.p.tblwidth + "px");
					...
					return this.each(function() {
						...
						if (this.grid)
							if (typeof d != "undefined") {
								...
								if (g >= 0) {
									var h = a("tr.ui-jqgrid-labels th:eq(" + g
											+ ")", this.grid.hDiv);
									if (e) {
										var j = a(".s-ico", h);
										a("[id^=jqgh_]", h).empty().html(e)
												.append(j);
										this.p.colNames[g] = e
									}
									if (c)
										typeof c === "string" ? a(h)
												.addClass(c) : a(h).css(c);
										...
										if (b = this.rows.namedItem(d)) {
											...
											if (c !== "" || h === true) {
												...
												if (this.p.datatype == "local") {
													b = this.p.colModel[j];
													c = b.formatter
															&& typeof b.formatter === "string"
															&& b.formatter == "date" ? a.unformat
															.date(c, b)
															: c;
													m = this.p._index[d];
													if (typeof m != "undefined")
														this.p.data[m][b.name] = c
												}
											}
											if (typeof f === "string")
												a(l).addClass(f);
				...
				getCell : function(d, e) {
					...
					this
							.each(function() {
								...
								if (this.grid) {
									if (isNaN(e))
										a(this.p.colModel).each(function(j) {
											if (this.name === e) {
												f = j;
												return false
											}
							...
							.each(function() {
								...
								if (this.grid) {
									...
									if (l >= 0) {
										...
										if (n && n > 0) {
											for (; k < n;) {
												if (a(this.rows[k]).hasClass(
														"jqgrow")) {
													try {
														g = a
																.unformat(
																		a(this.rows[k].cells[l]),
																		{
														...
														g = a.jgrid
																.htmlDecode(this.rows[k].cells[l].innerHTML)
													}
													if (c) {
														m = parseFloat(g);
														h += m;
								...
								if (this.grid) {
									...
									if (this.p.deepempty)
										...
										var e = a("#" + a.jgrid.jqID(this.p.id)
												+ " tbody:first tr:first")[0];
										a(
												"#" + a.jgrid.jqID(this.p.id)
														+ " tbody:first")
												.empty().append(e)
									}
									this.p.footerrow
											&& d
											&& a(".ui-jqgrid-ftable td",
													this.grid.sDiv).html(
													"&#160;");
									this.p.selrow = null;
									this.p.selarrrow = [];
				...
				getInd : function(d, e) {
					var c = false, f;
					this.each(function() {
						if (f = this.rows.namedItem(d))
							c = e === true ? f : f.rowIndex
					});
					return c
				},
				bindKeys : function(d) {
							...
							.each(function() {
								...
								a(c)
										.keydown(
												function(f) {
													var g = a(c).find(
															"tr[tabindex=0]")[0], h, j, b, m = c.p.treeReader.expanded_field;
													if (g) {
														b = c.p._index[g.id];
														if (f.keyCode === 37
																|| f.keyCode === 38
				...
				setColProp : function(d, e) {
					return this
							.each(function() {
								if (this.grid)
									if (e)
										for ( var c = this.p.colModel, f = 0; f < c.length; f++)
											if (c[f].name == d) {
				...
				sortGrid : function(d, e, c) {
					return this.each(function() {
						...
						if (this.grid) {
							if (!d)
								d = this.p.sortname;
							for ( var g = 0; g < this.p.colModel.length; g++)
								if (this.p.colModel[g].index == d
										|| this.p.colModel[g].name == d) {
									f = g;
									break
								}
							if (f != -1) {
							...
							.each(function() {
								...
								if (!this.ftoolbar) {
									var f = function() {
											...
											a
													.each(
															...
															function(s, x) {
																c.p.postData
																		.hasOwnProperty(x)
																		&& delete c.p.postData[x]
															})
										} else
											a.extend(c.p.postData, j);
										var q;
										if (c.p.searchurl) {
											q = c.p.url;
										...
										var r = false;
										if (a.isFunction(d.beforeSearch))
											r = d.beforeSearch.call(c);
									...
									a
											.each(
													...
													function() {
														var j = this, b, m, l, n;
														m = a("<th role='columnheader' class='ui-state-default ui-th-column ui-th-"
																+ c.p.direction
																+ "'></th>");
															...
															case "select":
																if (n = this.surl
																					...
																					.extend(
																							{
																								...
																								complete : function(
																									...
																									l.dataInit !== undefined
																											&& l
																													.dataInit(a(
																															"select",
																															b)[0]);
																									l.dataEvents !== undefined
																											&& e(
																													a(
																															"select",
																															b)[0],
																	...
																	if (j.searchoptions
																		...
																		k = j.searchoptions.value;
																	else if (j.editoptions
																			&& j.editoptions.value)
																		k = j.editoptions.value;
																	if (k) {
																		n = document
									...
									this.clearToolbar = function(j) {
										...
										var q = false;
										if (a.isFunction(d.beforeClear))
											q = d.beforeClear.call(c);
...
(function(a) {
	a.fn.jqm = function(n) {
		...
		return this.each(function() {
			if (this._jqm)
				return e[this._jqm].c = a.extend({}, e[this._jqm].c, n);
			d++;
			this._jqm = d;
			e[d] = {
	...
	a.jqm = {
		hash : {},
		open : function(n, k) {
			var p = e[n], o = p.c, v = "." + o.closeClass, q = parseInt(p.w
					.css("z-index"));
			q = q > 0 ? q : 3E3;
			var r = a("<div></div>").css({
				height : "100%",
			...
			if (o.modal) {
				...
				o.closeoverlay && p.w.jqmAddClose(r);
			else
				r = g;
			...
			if (f) {
				...
				if (r) {
					...
					for ( var s in {
						...
						r.style.setExpression(s.toLowerCase(),
								"(_=(document.documentElement.scroll" + s
	...
	var d = 0, e = a.jqm.hash, c = [], f = a.browser.msie
			&& a.browser.version == "6.0", g = false, h = function(n) {
		var k = a(
		...
		if (f)
			if (n.o)
				n.o.html('<p style="width:100%;height:100%"/>').prepend(k);
			else
				a("iframe.jqm", n.w)[0] || n.w.prepend(k);
		j(n)
	}, j = function(n) {
		try {
...
var xmlJsonClass = {
	...
	json2xml : function(a, d) {
		var e = function(g, h, j) {
			...
			if (g instanceof Array)
				...
				b += typeof g === "function" ? j + "<" + h + "><![CDATA[" + g
						+ "]]\></" + h + ">" : g.toString() === '""'
						|| g.toString().length === 0 ? j + "<" + h
						+ ">__EMPTY_STRING_</" + h + ">" : j + "<" + h + ">"
						+ g.toString() + "</" + h + ">";
			return b
		}, c = "", f;
		for (f in a)
		...
		if (a.nodeType === 1) {
			if (a.attributes.length) {
				...
				for (c = 0; c < a.attributes.length; c += 1)
					d["@" + a.attributes[c].nodeName] = (a.attributes[c].nodeValue || "")
							.toString()
			}
			if (a.firstChild) {
				var f = c = 0, g = false, h;
				...
				if (g)
					if (c < 2 && f < 2) {
						...
						for (h = a.firstChild; h; h = h.nextSibling)
							if (h.nodeType === 3)
								d["#text"] = this.escape(h.nodeValue);
							else if (h.nodeType === 4)
								if (e.test(h.nodeValue))
									d[h.nodeName] = [ d[h.nodeName],
											h.nodeValue ];
								else
									d["#cdata"] = this.escape(h.nodeValue);
							else if (d[h.nodeName])
								if (d[h.nodeName] instanceof Array)
									d[h.nodeName][d[h.nodeName].length] = this
											.toObj(h);
								else
									d[h.nodeName] = [ d[h.nodeName],
											this.toObj(h) ];
							else
								d[h.nodeName] = this.toObj(h)
					} else if (a.attributes.length)
						d["#text"] = this.escape(this.innerXml(a));
					else
			...
			d = this.toObj(a.documentElement);
		else
	...
	toJson : function(a, d, e, c) {
		...
		if (a === "[]")
			...
			var j, b, m = [];
			b = 0;
			for (j = a.length; b < j; b += 1)
				m[b] = this.toJson(a[b], "", e + g, c);
			f += (d ? ":[" : "[")
					+ (m.length > 1 ? h + e + g + m.join("," + h + e + g) + h
							+ e : m.join("")) + "]"
		} else if (a === null)
			f += (d && ":") + "null";
			...
			for (b in a)
				if (a.hasOwnProperty(b))
					j[j.length] = this.toJson(a[b], b, e + g, c);
			f += (d ? ":{" : "{")
					+ (j.length > 1 ? h + e + g + j.join("," + h + e + g) + h
							+ e : j.join("")) + "}"
		} else
			f += typeof a === "string" ? (d && ":") + '"'
	...
	innerXml : function(a) {
		...
		if ("innerHTML" in a)
			...
			var e = function(c) {
				...
				if (c.nodeType === 1) {
					f += "<" + c.nodeName;
					for (g = 0; g < c.attributes.length; g += 1)
						f += " " + c.attributes[g].nodeName + '="'
								+ (c.attributes[g].nodeValue || "").toString()
								+ '"';
					if (c.firstChild) {
						f += ">";
						for (g = c.firstChild; g; g = g.nextSibling)
							f += e(g);
						f += "</" + c.nodeName + ">"
					} else
						f += "/>"
...
(function(a) {
	...
	a.extend(a.fmatter, {
		...
		isValue : function(d) {
			return this.isObject(d) || this.isString(d) || this.isNumber(d)
					|| this.isBoolean(d)
		},
		isEmpty : function(d) {
			if (!this.isString(d) && this.isValue(d))
				return false;
			else if (!this.isValue(d))
				return true;
	...
	a.fmatter.util = {
		NumberFormat : function(d, e) {
			...
			if (a.fmatter.isNumber(d)) {
				var c = d < 0, f = d + "", g = e.decimalSeparator ? e.decimalSeparator
						: ".", h;
		...
		DateFormat : function(d, e, c, f) {
			var g = /^\/Date\((([-+])?[0-9]+)(([-+])([0-9]{2})([0-9]{2}))?\)\/$/, h = typeof e === "string" ? e
					.match(g)
					: null;
			g = function(s, x) {
				s = String(s);
				for (x = parseInt(x, 10) || 2; s.length < x;)
					s = "0" + s;
				return s
			};
			var j = {
			...
			if (e.constructor === Number) {
				...
				for (m = d.length; h < m; h++) {
					...
					if (e[h])
						j[d[h].toLowerCase()] = parseInt(e[h], 10)
				}
				if (j.f)
					j.m = j.f;
				if (j.m === 0 && j.y === 0 && j.d === 0)
					return "&#160;";
			...
			var n = b.getSeconds(), k = b.getMilliseconds(), p = b.getDay(), o = b
					.getFullYear(), v = (p + 6) % 7 + 1, q = (new Date(o,
					h - 1, j) - new Date(o, 0, 1)) / 864E5, r = {
				d : g(j),
				D : l.i18n.dayNames[p],
				j : j,
				...
				w : p,
				z : q,
				W : v < 5 ? Math.floor((q + v - 1) / 7) + 1 : Math
						.floor((q + v - 1) / 7)
						|| (((new Date(o - 1, 0, 1)).getDay() + 6) % 7 < 4 ? 53
								: 52),
				...
				I : "?",
				O : (m > 0 ? "-" : "+")
						+ g(Math.floor(Math.abs(m) / 60) * 100 + Math.abs(m)
								% 60, 4),
				P : "?",
				T : (String(b)
						.match(
	...
	a.fn.fmatter.link = function(d, e) {
		...
		if (c.target)
			f = "target=" + c.target;
		return a.fmatter.isEmpty(d) ? a.fn.fmatter.defaultFormat(d, e) : "<a "
				+ f + ' href="' + d + '">' + d + "</a>"
	};
	a.fn.fmatter.showlink = function(d, e) {
		...
		if (c.target)
			f = "target=" + c.target;
		c = c.baseLinkUrl + c.showAction + "?" + c.idName + "=" + e.rowId
				+ c.addParam;
		return a.fmatter.isString(d) || a.fmatter.isNumber(d) ? "<a " + f
				+ ' href="' + c + '">' + d + "</a>" : a.fn.fmatter
				.defaultFormat(d, e)
	};
	...
	a.fn.fmatter.date = function(d, e, c, f) {
		...
		a.fmatter.isUndefined(e.colModel.formatoptions)
				|| (c = a.extend({}, c, e.colModel.formatoptions));
		return !c.reformatAfterEdit && f == "edit" ? a.fn.fmatter
				.defaultFormat(d, e) : a.fmatter.isEmpty(d) ? a.fn.fmatter
				.defaultFormat(d, e) : a.fmatter.util.DateFormat(c.srcformat,
				d, c.newformat, c)
	};
	a.fn.fmatter.select = function(d, e) {
		...
		if (c) {
			...
			if (a.fmatter.isString(c))
				for ( var b = c.split(";"), m = 0, l = 0; l < b.length; l++) {
					j = b[l].split(":");
					if (j.length > 2)
						j[1] = jQuery.map(j, function(n, k) {
							if (k > 0)
								return n
						}).join(":");
					if (g) {
	...
	a.fn.fmatter.rowactions = function(d, e, c, f) {
		...
		a.fmatter.isUndefined(f.formatoptions)
				|| (g = a.extend(g, f.formatoptions));
		if (!a.fmatter.isUndefined(a("#" + e)[0].p.editOptions))
			g.editOptions = a("#" + e)[0].p.editOptions;
		if (!a.fmatter.isUndefined(a("#" + e)[0].p.delOptions))
			g.delOptions = a("#" + e)[0].p.delOptions;
		f = function(j) {
			g.afterSave && g.afterSave(j);
			a(
					"tr#" + d + " div.ui-inline-edit, tr#" + d
							+ " div.ui-inline-del",
					"#" + e + ".ui-jqgrid-btable:first").show();
			a(
					"tr#" + d + " div.ui-inline-save, tr#" + d
		...
		switch (c) {
		case "edit":
			a("#" + e).jqGrid("editRow", d, g.keys, g.onEdit, g.onSuccess,
			...
			break;
		case "save":
			if (a("#" + e).jqGrid("saveRow", d, g.onSuccess, g.url,
	...
	a.fn.fmatter.actions = function(d, e) {
		...
		a.fmatter.isUndefined(e.colModel.formatoptions)
				|| (c = a.extend(c, e.colModel.formatoptions));
		var f = e.rowId, g = "", h;
		if (typeof f == "undefined" || a.fmatter.isEmpty(f))
			return "";
		if (c.editformbutton) {
		...
		g = g
				...
				+ h + "><span class='ui-icon ui-icon-disk'></span></div>";
		h = "onclick=$.fn.fmatter.rowactions('"
				+ f
				+ "','"
				+ e.gid
		...
		g = g
				...
				+ h + "><span class='ui-icon ui-icon-cancel'></span></div>";
		return "<div style='margin-left:8px;'>" + g + "</div>"
	};
	a.unformat = function(d, e, c, f) {
		var g, h = e.colModel.formatter, j = e.colModel.formatoptions || {}, b = /([\.\*\_\'\(\)\{\}\+\?\\])/g, m = e.colModel.unformat
				|| a.fn.fmatter[h] && a.fn.fmatter[h].unformat;
		if (typeof m !== "undefined" && a.isFunction(m))
			g = m(a(d).text(), e, d);
			...
			case "number":
				...
				e = j.thousandsSeparator.replace(b, "\\$1");
				g = a(d).text().replace(RegExp(e, "g"), "").replace(
						j.decimalSeparator, ".");
				break;
			case "currency":
				...
				e = j.thousandsSeparator.replace(b, "\\$1");
				g = a(d).text().replace(RegExp(e, "g"), "").replace(
						j.decimalSeparator, ".").replace(j.prefix, "").replace(
						j.suffix, "");
				break;
			case "checkbox":
				j = e.colModel.editoptions ? e.colModel.editoptions.value
						.split(":") : [ "Yes", "No" ];
		...
		return g !== undefined ? g : f === true ? a(d).text() : a.jgrid
				.htmlDecode(a(d).html())
	};
	a.unformat.select = function(d, e, c, f) {
		...
		if (e.value) {
			...
			if (a.fmatter.isString(g))
				for ( var j = g.split(";"), b = 0, m = 0; m < j.length; m++) {
					h = j[m].split(":");
					if (h.length > 2)
						h[1] = jQuery.map(h, function(l, n) {
							if (n > 0)
								return l
						}).join(":");
					if (e) {
	...
	a.unformat.date = function(d, e) {
		...
		return a.fmatter.isEmpty(d) ? a.fn.fmatter.defaultFormat(d, e)
				: a.fmatter.util.DateFormat(c.newformat, d, c.srcformat, c)
	}
})(jQuery);
(function(a) {
	a
			.extend(
					a.jgrid,
					{
						...
						createModal : function(d, e, c, f, g, h, j) {
							...
							if (m) {
								b.dir = "rtl";
								a(".ui-jqdialog-title", n)
										.css("float", "right");
								a(".ui-jqdialog-titlebar-close", n).css("left",
										"0.3em")
							} else {
								b.dir = "ltr";
								a(".ui-jqdialog-title", n).css("float", "left");
								a(".ui-jqdialog-titlebar-close", n).css(
										"right", "0.3em")
							}
							...
							if (h === true)
								...
								typeof h == "string" ? a(h).append(b) : a(b)
										.insertBefore(f);
							a(b).css(j);
							...
							a("a.ui-jqdialog-titlebar-close", n).click(
									function() {
										var q = a("#" + d.themodal).data(
												"onClose")
												|| c.onClose, r = a(
												"#" + d.themodal).data("gbox")
												|| c.gbox;
							...
							if (m && e.left && !h) {
								f = a(c.gbox).width()
										- (!isNaN(c.width) ? parseInt(c.width,
												10) : 0) - 8;
							...
							a(b).css(
									a.extend({
										width : isNaN(c.width) ? "auto"
												: c.width + "px",
										height : isNaN(c.height) ? "auto"
												: c.height + "px",
										zIndex : c.zIndex,
										overflow : "hidden"
									}, e)).attr({
							...
							if (c.resize)
								if (a.fn.jqResize) {
									...
									a("#" + d.themodal).jqResize(
											".jqResize",
											d.scrollelm ? "#" + d.scrollelm
													: false)
								} else
									try {
										a(b)
						...
						viewModal : function(d, e) {
							...
							if (a.fn.jqm && e.jqm === true)
								e.jqM ? a(d).attr("aria-hidden", "false")
										.jqm(e).jqmShow() : a(d).attr(
						...
						info_dialog : function(d, e, c, f) {
							...
							b += c ? "<div class='ui-widget-content ui-helper-clearfix' style='text-align:"
									...
									+ c + "</a>" + d + "</div>"
									: d !== "" ? "<div class='ui-widget-content ui-helper-clearfix' style='text-align:"
											+ g.buttonalign
						...
						createEl : function(d, e, c, f, g) {
							...
							function j(p, o, v) {
								var q = [ "dataInit", "dataEvents", "dataUrl",
										"buildSelect", "sopt", "searchhidden",
										"defaultValue", "attr" ];
								if (typeof v != "undefined" && a.isArray(v))
									q = a.extend(q, v);
								a.each(o, function(r, s) {
									a.inArray(r, q) === -1 && a(p).attr(r, s)
								});
								o.hasOwnProperty("id")
										|| a(p).attr("id", a.jgrid.randId())
							}
							var b = "";
							switch (d) {
							case "textarea":
							...
							case "checkbox":
								...
								if (e.value) {
									...
									d = c.toLowerCase();
									if (d.search(/(false|0|no|off|undefined)/i) < 0
											&& d !== "") {
										b.checked = true;
										b.defaultChecked = true;
										b.value = c
													...
													.extend(
															{
																...
																success : function(
																		p) {
																	var o = [], v = this.elem, q = this.vl, r = a
																			.extend(
																					{},
																					this.options), s = r.multiple === true;
																	if (typeof r.buildSelect != "undefined")
																		p = r
																				.buildSelect(p);
																	if (p = a(p)
																			.html()) {
							...
							case "custom":
								...
								try {
									if (a.isFunction(e.custom_element))
										if (l = e.custom_element.call(this, c,
												e)) {
											l = a(l).addClass("customelement")
													.attr({
														id : e.id,
														name : e.name
													});
						...
						checkDate : function(d, e) {
							...
							if (j === -1)
								...
								m = c[d[j]].toString();
								if (m.length < 1 || c[d[j]] < 1 || c[d[j]] > 12)
									return false
							}
							if (h === -1)
								return false;
						...
						checkValues : function(d, e, c, f, g) {
							...
							if (h) {
								...
								if (typeof h.minValue != "undefined"
										&& !isNaN(h.minValue))
									if (parseFloat(d) < parseFloat(h.minValue))
										return [
												false,
												j
														+ ": "
								...
								if (typeof h.maxValue != "undefined"
										&& !isNaN(h.maxValue))
									if (parseFloat(d) > parseFloat(h.maxValue))
										return [
												false,
												j
														+ ": "
								...
								if (h.date === true)
									if (!(f === false && this.isEmpty(d))) {
										e = c.p.colModel[e].formatoptions
												&& c.p.colModel[e].formatoptions.newformat ? c.p.colModel[e].formatoptions.newformat
												: c.p.colModel[e].datefmt
														|| "Y-m-d";
										if (!this.checkDate(e, d))
											return [
													false,
													j
															+ ": "
		...
		return this
				.each(function() {
					if (!this.filter) {
						...
						var g, h = this.p.columns.length, j, b = /msie/i
								.test(navigator.userAgent)
								&& !window.opera;
						if (this.p._gridsopt.length)
							for (g = 0; g < this.p._gridsopt.length; g++)
								this.p.ops[g].description = this.p._gridsopt[g];
						...
						if (h) {
							...
							this.p.showQuery
									&& a(this)
											.append(
													"<table class='queryresult ui-widget ui-widget-content' style='display:block;max-width:440px;border:0px none;'><tbody><tr><td class='query'></td></tr></tbody></table>");
							var m = function(l, n) {
								var k = [ true, "" ];
								if (a.isFunction(n.searchrules))
									k = n.searchrules(l, n);
								else if (a.jgrid && a.jgrid.checkValues)
									try {
										k = a.jgrid.checkValues(l, -1, null,
												n.searchrules, n.label)
									} catch (p) {
									}
							...
							this.reDraw = function() {
								...
								var l = this
										.createTableForGroup(f.filter, null);
								a(this).append(l);
							...
							this.createTableForGroup = function(l, n) {
								...
								n === null
										&& a(o)
												.append(
														"<tr class='error' style='display:none;'><th colspan='5' class='ui-state-error' align='left'></th></tr>");
								var v = a("<tr></tr>");
								a(o).append(v);
											...
											.bind(
													...
													function() {
														...
														for (p = 0; p < k.p.columns.length; p++) {
															var A = typeof k.p.columns[p].search === "undefined" ? true
																	: k.p.columns[p].search, B = k.p.columns[p].hidden === true;
															if (k.p.columns[p].searchoptions.searchhidden === true
																	&& A
																	|| A
																	&& !B) {
																x = k.p.columns[p];
														...
														l.rules
																.push({
																	field : x.name,
																	op : (x.searchoptions.sopt ? x.searchoptions.sopt
																			: k.p.sopt ? k.p.sopt
																					: x.searchtype === "string" ? k.p.stropts
																							: k.p.numopts)[0],
																	data : ""
																});
														k.reDraw();
								...
								if (l.groups !== undefined)
									for (p = 0; p < l.groups.length; p++) {
										q = a("<tr></tr>");
										o.append(q);
										v = a("<td class='first'></td>");
										q.append(v);
										v = a("<td colspan='4'></td>");
										v.append(this.createTableForGroup(
												l.groups[p], l));
										q.append(v)
									}
								if (l.groupOp === undefined)
									l.groupOp = k.p.groupOps[0];
								if (l.rules !== undefined)
									for (p = 0; p < l.rules.length; p++)
										o.append(this.createTableRowForRule(
												l.rules[p], l));
								return o
							};
							this.createTableRowForRule = function(l, n) {
								...
								B
										.bind(
												...
												function() {
													...
													q = a(this).parents(
															"tr:first");
													for (o = 0; o < k.p.columns.length; o++)
														if (k.p.columns[o].name === l.field) {
															r = k.p.columns[o];
															break
														}
													if (r) {
														r.searchoptions.id = a.jgrid
																.randId();
														if (b
																&& r.inputtype === "text")
															if (!r.searchoptions.size)
																r.searchoptions.size = 10;
														var C = a.jgrid
																.createEl(
																		r.inputtype,
																		r.searchoptions,
														...
														a(C).addClass(
																"input-elm");
														v = r.searchoptions.sopt ? r.searchoptions.sopt
																: k.p.sopt ? k.p.sopt
																		: r.searchtype === "string" ? k.p.stropts
																				: k.p.numopts;
														var R = "", ca = "";
														y = [];
														a
								...
								for (o = A = 0; o < k.p.columns.length; o++) {
									x = typeof k.p.columns[o].search === "undefined" ? true
											: k.p.columns[o].search;
									var G = k.p.columns[o].hidden === true;
									if (k.p.columns[o].searchoptions.searchhidden === true
											&& x || x && !G) {
										x = "";
								...
								if (b && r.inputtype === "text")
									if (!r.searchoptions.size)
										r.searchoptions.size = 10;
								A = a.jgrid.createEl(r.inputtype,
										r.searchoptions, l.data, true,
										k.p.ajaxSelectOptions, true);
							...
							this.getStringForGroup = function(l) {
								var n = "(", k;
								if (l.groups !== undefined)
									for (k = 0; k < l.groups.length; k++) {
										if (n.length > 1)
											n += " " + l.groupOp + " ";
										try {
											n += this
													.getStringForGroup(l.groups[k])
										} catch (p) {
											alert(p)
										}
									}
							...
							this.getStringForRule = function(l) {
								var n = "", k = "", p, o;
								for (p = 0; p < this.p.ops.length; p++)
									if (this.p.ops[p].name === l.op) {
										n = this.p.ops[p].operator;
										k = this.p.ops[p].name;
										break
									}
								for (p = 0; p < this.p.columns.length; p++)
									if (this.p.columns[p].name === l.field) {
										o = this.p.columns[p];
										break
									}
								p = l.data;
								...
								return a.inArray(o.searchtype, [ "int",
							...
							this.toString = function() {
								function l(k) {
									var p = "(", o;
									if (k.groups !== undefined)
										for (o = 0; o < k.groups.length; o++) {
											if (p.length > 1)
												p += k.groupOp === "OR" ? " || "
														: " && ";
											p += l(k.groups[o])
									...
									if (k.rules !== undefined)
										for (o = 0; o < k.rules.length; o++) {
											...
											if (n.p.errorcheck) {
												...
												for (q = 0; q < n.p.columns.length; q++)
													if (n.p.columns[q].name === v.field) {
														r = n.p.columns[q];
														break
													}
												r && m(v.data, r)
								...
								if (c.grid) {
									...
									if (a("#" + h.themodal).html() !== null)
										...
										var b = a(
												...
												.insertBefore(
														"#gview_" + c.p.id);
										if (a.isFunction(d.onInitializeSearch))
											d.onInitializeSearch(a("#" + f));
										var m = a.extend([], c.p.colModel), l = "<a href='javascript:void(0)' id='"
												+ f
												...
												+ d.Find + "</a>", n = "<a href='javascript:void(0)' id='"
												+ f
												...
												+ d.Reset + "</a>", k = "", p = "", o, v = false, q = -1;
										if (d.showQuery)
											k = "<a href='javascript:void(0)' id='"
													+ f
										...
										if (d.columns.length)
											...
											a
													.each(
															...
															function(s, x) {
																if (!x.label)
																	x.label = c.p.colNames[s];
																if (!v) {
																	var A = typeof x.search === "undefined" ? true
																			: x.search, B = x.hidden === true;
																	if (x.searchoptions
																			&& x.searchoptions.searchhidden === true
																			&& A
																			|| A
																			&& !B) {
																		v = true;
										...
										if (!j && o
												|| d.multipleSearch === false) {
											var r = "eq";
											if (q >= 0 && m[q].searchoptions
													&& m[q].searchoptions.sopt)
												r = m[q].searchoptions.sopt[0];
											else if (d.sopt && d.sopt.length)
												r = d.sopt[0];
											j = {
												groupOp : "AND",
												rules : [ {
																...
																function() {
																	...
																	s == "default" ? a(
																			...
																			: a(
																					...
																					.jqFilter(
																							"addFilter",
																							d.tmplFilters[parseInt(
																									s,
																									10)]);
																	return false
																});
										if (d.multipleGroup === true)
											d.multipleSearch = true;
										if (a.isFunction(d.onInitializeSearch))
											d.onInitializeSearch(a("#" + f));
										d.layer ? a.jgrid.createModal(h, b, d,
												"#gview_" + c.p.id, a("#gbox_"
														+ c.p.id)[0], "#"
														+ d.layer, {
													position : "relative"
												}) : a.jgrid.createModal(h, b,
												d, "#gview_" + c.p.id,
												a("#gbox_" + c.p.id)[0]);
										k
												&& a("#" + f + "_query")
										...
										if (d.stringResult === undefined)
											d.stringResult = d.multipleSearch;
										a("#" + f + "_search")
												.bind(
														"click",
														function() {
												...
												.bind(
														...
														function() {
															...
															if (d.multipleSearch === false)
																s[d.sField] = s[d.sValue] = s[d.sOper] = "";
															else
																s[d.sFilter] = "";
															x[0].resetFilter();
															v
					...
					return this
							.each(function() {
								...
								function g(E, H, U, M) {
									...
									for (na = 1; na <= M; na++)
										ta += "<td class='CaptionTD'>&#160;</td><td class='DataTD'>&#160;</td>";
									if (E != "_empty")
										ba = a(H).jqGrid("getInd", E);
									a(H.p.colModel)
											.each(
													function(wa) {
														Q = this.name;
														...
														if (Q !== "cb"
															...
															a(
																	...
																	Z[0])
																	.html(
																			typeof w.label === "undefined" ? H.p.colNames[wa]
																					: w.label);
															a(
																	"td:eq("
																			+ (D - 1)
									...
									if (da > 0) {
										na = a("<tr class='FormData' style='display:none'><td class='CaptionTD'></td><td colspan='"
												+ (M * 2 - 1)
																...
																if (M !== "cb"
																	...
																	case "select":
																		...
																		a(
																				...
																				.each(
																						function() {
																							this.selected = !fa[ba].editoptions.multiple
																									&& (na[0] == a
																											.trim(a(
																													this)
																													.text()) || na[0] == a
																	...
																	case "checkbox":
																		Y += "";
																		if (fa[ba].editoptions
																				&& fa[ba].editoptions.value)
																			if (fa[ba].editoptions.value
																					.split(":")[0] == Y) {
																				a(
																						"#"
																								+ M,
																	...
																	case "custom":
																		try {
																			if (fa[ba].editoptions
																					&& a
																							.isFunction(fa[ba].editoptions.custom_value))
																				fa[ba].editoptions
																						.custom_value(
																								a(
																										"#"
								...
								function j() {
									...
									if (H[0]) {
										if (a.isFunction(c.onclickSubmit))
											U = c.onclickSubmit(c, C) || {};
										if (a.isFunction(c.beforeSubmit))
											H = c.beforeSubmit(C, a("#" + q))
									}
									if (H[0] && !c.processing) {
										c.processing = true;
										a("#sData", "#" + r + "_2").addClass(
												"ui-state-active");
										Y = M.oper;
										Q = M.id;
										C[Y] = a.trim(C[o.p.id + "_id"]) == "_empty" ? M.addoper
												: M.editoper;
										if (C[Y] != M.addoper)
											C[Q] = C[o.p.id + "_id"];
										...
										if (o.p.treeGrid === true) {
											if (C[Y] == M.addoper) {
												da = a(o).jqGrid(
														"getGridParam",
														"selrow");
												C[o.p.treeGridModel == "adjacency" ? o.p.treeReader.parent_id_field
														: "parent_id"] = da
											}
																	...
																	if (c.checkOnSubmit
																		...
																		a(
																				...
																				.data(
																						"disabled",
																						false);
																		if (c._savedData[o.p.id
																				+ "_id"] != "_empty")
																			for ( var ma in c._savedData)
																				if (C[ma])
										...
										if (H[0])
											c.useDataProxy ? o.p.dataProxy
													.call(o, U, "set_" + o.p.id)
													: a.ajax(U)
									}
									if (H[0] === false) {
								...
								function m() {
									a
											.each(
													...
													function(E, H) {
														if (H.editoptions
																&& H.editoptions.NullIfEmpty === true)
															if (C
																	.hasOwnProperty(H.name)
																	&& C[H.name] == "")
																C[H.name] = "null"
													})
								}
								...
								function n() {
									if (d !== "_empty"
											&& typeof o.p.savedRow !== "undefined"
											&& o.p.savedRow.length > 0
											&& a
													.isFunction(a.fn.jqGrid.restoreRow))
										for ( var E = 0; E < o.p.savedRow.length; E++)
											if (o.p.savedRow[E].id == d) {
								...
								function p() {
									var E = a(o).jqGrid("getDataIDs"), H = a(
											"#id_g", "#" + r).val();
									return [ a.inArray(H, E), E ]
								}
								var o = this;
								if (o.grid && d) {
									var v = o.p.id, q = "FrmGrid_" + v, r = "TblGrid_"
											+ v, s = {
										themodal : "editmod" + v,
										modalhead : "edithd" + v,
										modalcontent : "editcnt" + v,
										scrollelm : q
									}, x = a.isFunction(c.beforeShowForm) ? c.beforeShowForm
											: false, A = a
											...
											: false, y = true, G = 1, S = 0, C, R, ca, ka;
									if (d === "new") {
										d = "_empty";
										e.caption = c.addCaption
									} else
										e.caption = c.editCaption;
									e.recreateForm === true
											&& a("#" + s.themodal).html() !== null
											&& a("#" + s.themodal).remove();
									var ia = true;
									if (e.checkOnUpdate && e.jqModal
											&& !e.modal)
										ia = false;
									if (a("#" + s.themodal).html() !== null) {
										...
										var qa = isNaN(e.dataheight) ? e.dataheight
												: e.dataheight + "px";
										qa = a(
										...
										B[0].rp = 0;
										a(xa).append(B);
										B = a("<tr style='display:none' class='tinfo'><td class='topinfo' colspan='"
												+ G
												* 2
												+ "'>"
												+ c.topinfo
										...
										var Ba = "<a href='javascript:void(0)' id='sData' class='fm-button ui-state-default ui-corner-all'>"
												+ e.bSubmit + "</a>", pa = "<a href='javascript:void(0)' id='cData' class='fm-button ui-state-default ui-corner-all'>"
												+ e.bCancel + "</a>";
										y = "<table border='0' cellspacing='0' cellpadding='0' class='EditTable' id='"
												+ r
												+ "_2'><tbody><tr><td colspan='2'><hr class='ui-widget-content' style='margin:1px'/></td></tr><tr id='Act_Buttons'><td class='navButton'>"
												+ (B ? Aa + y : y + Aa)
												+ "</td><td class='EditButton'>"
												+ Ba + pa + "</td></tr>";
										y += "<tr style='display:none' class='binfo'><td class='bottominfo' colspan='2'>"
												+ c.bottominfo + "</td></tr>";
										y += "</tbody></table>";
										if (S > 0) {
											var Ca = [];
										...
										qa = a("<span></span>").append(qa)
												.append(y);
										a.jgrid.createModal(s, qa, e, "#gview_"
												+ o.p.id,
												a("#gbox_" + o.p.id)[0]);
										if (B) {
											a("#pData, #nData", "#" + r + "_2")
										...
										e.saveicon = a.extend([ true, "left",
												"ui-icon-disk" ], e.saveicon);
										e.closeicon = a.extend([ true, "left",
												"ui-icon-close" ], e.closeicon);
										if (e.saveicon[0] === true)
											a("#sData", "#" + r + "_2")
													.addClass(
															e.saveicon[1] == "right" ? "fm-button-icon-right"
																	: "fm-button-icon-left")
													.append(
															"<span class='ui-icon "
																	+ e.saveicon[2]
																	+ "'></span>");
										if (e.closeicon[0] === true)
											a("#cData", "#" + r + "_2")
													.addClass(
															e.closeicon[1] == "right" ? "fm-button-icon-right"
																	: "fm-button-icon-left")
													.append(
															"<span class='ui-icon "
																	+ e.closeicon[2]
										...
										if (c.checkOnSubmit || c.checkOnUpdate) {
											Ba = "<a href='javascript:void(0)' id='sNew' class='fm-button ui-state-default ui-corner-all' style='z-index:1002'>"
													+ e.bYes + "</a>";
											Aa = "<a href='javascript:void(0)' id='nNew' class='fm-button ui-state-default ui-corner-all' style='z-index:1002'>"
													+ e.bNo + "</a>";
											pa = "<a href='javascript:void(0)' id='cNew' class='fm-button ui-state-default ui-corner-all' style='z-index:1002'>"
													+ e.bExit + "</a>";
											qa = e.zIndex || 999;
											qa++;
											a(
															...
															if (E[0] != -1
																...
																a(o)
																		.jqGrid(
																				...
																				E[1][E[0] + 1]);
																a
																		.isFunction(e.afterclickPgButtons)
																		&& e
																				.afterclickPgButtons(
																						"next",
																						a("#"
				...
				viewGridRow : function(d, e) {
					...
					return this
							.each(function() {
								...
								function f(y, G, S, C) {
									for ( var R, ca, ka, ia = 0, qa, xa, Aa = [], Ba = false, pa = "<td class='CaptionTD form-view-label ui-widget-content' width='"
											+ e.labelswidth
											+ "'>&#160;</td><td class='DataTD form-view-data ui-helper-reset ui-widget-content'>&#160;</td>", Ca = "", va = [
											"integer", "number", "currency" ], E = 0, H = 0, U, M, Q, Y = 1; Y <= C; Y++)
										Ca += Y == 1 ? pa
													...
													function(Z) {
														...
														xa = (ca = this.editrules
																...
																: this.hidden === true ? true
																		: false) ? "style='display:none'"
																: "";
														Q = typeof this.viewable != "boolean" ? true
																: this.viewable;
														if (R !== "cb"
																&& R !== "subgrid"
																&& R !== "rn"
															...
															var da = a
																	...
																	10);
															if (da.rowabove) {
																var fa = a("<tr><td class='contentinfo' colspan='"
																		+ C
																		* 2
																		+ "'>"
																		+ da.rowcontent
															...
															a(
																	...
																	.html(
																			"<b>"
																					+ (typeof da.label === "undefined" ? G.p.colNames[Z]
																							: da.label)
																					+ "</b>");
															a(
																	"td:eq("
									...
									if (ia > 0) {
										y = a("<tr class='FormData' style='display:none'><td class='CaptionTD'></td><td colspan='"
												+ (C * 2 - 1)
										...
										a("td", ka)
												.each(
														function(ia) {
															...
															C = G.p.colModel[ia].editrules
																	&& G.p.colModel[ia].editrules.edithidden === true ? false
																	: G.p.colModel[ia].hidden === true ? true
																			: false;
															if (S !== "cb"
																	&& S !== "subgrid"
																	&& S !== "rn") {
																ca = S == G.p.ExpandColumn
																		&& G.p.treeGrid === true ? a(
																		this)
																		.text()
																		: a(
								...
								function j() {
									var y = a(b).jqGrid("getDataIDs"), G = a(
											"#id_g", "#" + n).val();
								...
								if (b.grid && d) {
									if (!e.imgpath)
										e.imgpath = b.p.imgpath;
									var m = b.p.id, l = "ViewGrid_" + m, n = "ViewTbl_"
											+ m, k = {
										themodal : "viewmod" + m,
										modalhead : "viewhd" + m,
									...
									if (a("#" + k.themodal).html() !== null) {
										...
										a("#FormError", "#" + n).hide();
										g(d, b);
										a.isFunction(e.beforeShowForm)
												&& e.beforeShowForm(a("#" + l));
										...
										var r = isNaN(e.dataheight) ? e.dataheight
												: e.dataheight + "px";
										r = a("<form name='FormPost' id='"
												+ l
										...
										a(r).append(s);
										f(d, b, s, v);
										p = b.p.direction == "rtl" ? true
												: false;
										o = "<a href='javascript:void(0)' id='"
												+ (p ? "nData" : "pData")
												+ "' class='fm-button ui-state-default ui-corner-left'><span class='ui-icon ui-icon-triangle-1-w'></span></a>";
										var x = "<a href='javascript:void(0)' id='"
												+ (p ? "pData" : "nData")
										...
										r = a("<span></span>")
												...
												.append(
														"<table border='0' class='EditTable' id='"
																...
																+ A
																+ "</td></tr></tbody></table>");
										a.jgrid.createModal(k, r, e, "#gview_"
												+ b.p.id,
												a("#gview_" + b.p.id)[0]);
										if (p) {
											a("#pData, #nData", "#" + n + "_2")
				...
				delGridRow : function(d, e) {
					...
					return this
							.each(function() {
								...
								if (f.grid)
									if (d) {
										var g = a.isFunction(e.beforeShowForm), h = a
												.isFunction(e.afterShowForm), j = a
												.isFunction(e.beforeInitData) ? e.beforeInitData
												: false, b = f.p.id, m = {}, l = true, n = "DelTbl_"
												+ b, k, p, o, v, q = {
											themodal : "delmod" + b,
											modalhead : "delhd" + b,
										...
										if (a("#" + q.themodal).html() !== null) {
											...
											r += "<tr id='DelData' style='display:none'><td >"
													+ d + "</td></tr>";
											r += '<tr><td class="delmsg" style="white-space:pre;">'
													+ e.msg
													+ "</td></tr><tr><td >&#160;</td></tr>";
											r += "</tbody></table></div>";
											...
											e.delicon = a
													.extend(
															[ true, "left",
																	"ui-icon-scissors" ],
															e.delicon);
											e.cancelicon = a.extend([ true,
													"left", "ui-icon-cancel" ],
													e.cancelicon);
											if (e.delicon[0] === true)
												a("#dData", "#" + n + "_2")
														.addClass(
																e.delicon[1] == "right" ? "fm-button-icon-right"
																		: "fm-button-icon-left")
														.append(
																"<span class='ui-icon "
																		+ e.delicon[2]
																		+ "'></span>");
											if (e.cancelicon[0] === true)
												a("#eData", "#" + n + "_2")
														.addClass(
																e.cancelicon[1] == "right" ? "fm-button-icon-right"
																		: "fm-button-icon-left")
														.append(
																"<span class='ui-icon "
																		+ e.cancelicon[2]
																			...
																			.extend(
																					{
																						...
																						type : e.mtype,
																						data : a
																								.isFunction(e.serializeDelData) ? e
																								.serializeDelData(k)
																								: k,
																						complete : function(
																								B,
					...
					return this
							.each(function() {
								if (this.grid) {
									...
									if (c)
										if (!(e.id && a("#" + e.id, c).html() !== null)) {
											var g = a("<td></td>");
											e.buttonicon.toString()
													.toUpperCase() == "NONE" ? a(
													g)
													.addClass(
				...
				FormToGrid : function(d, e, c, f) {
					return this.each(function() {
						if (this.grid) {
							...
							if (c == "add")
								a(this).jqGrid("addRowData", d, h, f);
							else
								c == "set"
										&& a(this).jqGrid("setRowData", d, h)
						}
					})
				}
			})
	...
	a.jgrid
			.extend({
				editRow : function(d, e, c, f, g, h, j, b, m) {
					...
					k = n[0] && typeof n[0] == "object" && !a.isFunction(n[0]) ? a
							.extend(l, n[0])
							: l;
					return this
							.each(function() {
				...
				saveRow : function(d, e, c, f, g, h, j) {
					...
					l = m[0] && typeof m[0] == "object" && !a.isFunction(m[0]) ? a
							.extend(b, m[0])
							: b;
					...
					if (b === "1") {
											...
											if (p != "cb"
												...
												case "custom":
													try {
														if (A.editoptions
																&& a
																		.isFunction(A.editoptions.custom_value)) {
															o[p] = A.editoptions.custom_value
																	.call(
																			k,
																			a(
																					".customelement",
												...
												if (l.url !== "clientArray"
														&& A.editoptions
														&& A.editoptions.NullIfEmpty === true)
													if (o[p] == "")
														q[p] = "null"
											}
										});
						if (s[0] === false) {
							try {
								var B = a.jgrid.findPos(a(
										"#" + a.jgrid.jqID(d), k.grid.bDiv)[0]);
								a.jgrid.info_dialog(a.jgrid.errors.errcap,
										s[1], a.jgrid.edit.bClose, {
											left : B[0],
											top : B[1]
										})
							} catch (F) {
						...
						if (o) {
							...
							o[m] = b.editoper;
							o[B] = d;
							if (typeof k.p.inlineData == "undefined")
								k.p.inlineData = {};
						...
						if (l.url == "clientArray") {
							...
							a(x).attr("editable", "0");
							for (b = 0; b < k.p.savedRow.length; b++)
								if (k.p.savedRow[b].id == d) {
									r = b;
									break
								}
							r >= 0 && k.p.savedRow.splice(r, 1);
							a.isFunction(l.aftersavefunc)
									&& l.aftersavefunc.call(k, d, B);
							n = true
						} else {
							a("#lui_" + k.p.id).show();
							q = a.extend({}, o, q);
											...
											.extend(
													{
														url : l.url,
														data : a
																.isFunction(k.p.serializeRowData) ? k.p.serializeRowData
																.call(k, q)
																: q,
														type : "POST",
														async : false,
														complete : function(y,
															...
															if (G === "success")
																if ((a
																		.isFunction(l.successfunc) ? l.successfunc
																		.call(
																				k,
																				y)
																		: true) === true) {
																	...
																	a(x)
																			.attr(
																					"editable",
																					"0");
																	for ( var S = 0; S < k.p.savedRow.length; S++)
																		if (k.p.savedRow[S].id == d) {
																			r = S;
																			break
																		}
																	r >= 0
					...
					return this
							.each(function() {
								...
								if (c.grid) {
									...
									if (g !== false) {
										for ( var j = 0; j < c.p.savedRow.length; j++)
											if (c.p.savedRow[j].id == d) {
												f = j;
												break
											}
										if (f >= 0) {
													...
													.each(
															...
															function() {
																if (this.editable === true
																		&& this.name in c.p.savedRow[f]
																		&& !a(
																				this)
																				.hasClass(
																						"not-editable-cell"))
																	h[this.name] = c.p.savedRow[f][this.name]
															});
											a(c).jqGrid("setRowData", d, h);
											a(g).attr("editable", "0").unbind(
													"keydown");
								...
								if (!(!f.grid || f.p.cellEdit !== true)) {
									...
									if (!(g == "subgrid" || g == "cb" || g == "rn")) {
										...
										if (b.editable === true
											...
											if (parseInt(f.p.iCol, 10) >= 0
													&& parseInt(f.p.iRow, 10) >= 0) {
												a("td:eq(" + f.p.iCol + ")",
														f.rows[f.p.iRow])
														.removeClass(
													...
													.createEl(
															...
															a
																	.extend(
																			{},
																			a.jgrid.ajaxOptions,
																			f.p.ajaxSelectOptions
																					|| {}));
											a.isFunction(f.p.beforeEditCell)
													&& f.p.beforeEditCell.call(
															f, f.rows[d].id, g,
															h, d, e);
											a(j).html("").append(n).attr(
													"tabindex", "0");
											window.setTimeout(function() {
												a(n).focus()
											}, 0);
											a("input, select, textarea", j)
													.bind(
															"keydown",
															function(k) {
																if (k.keyCode === 27)
											...
											a.isFunction(f.p.afterEditCell)
													&& f.p.afterEditCell.call(
															f, f.rows[d].id, g,
															h, d, e)
										} else {
											if (parseInt(f.p.iCol, 10) >= 0
					...
					return this
							.each(function() {
								...
								if (!(!c.grid || c.p.cellEdit !== true)) {
									...
									if (f !== null) {
										var g = a("td:eq(" + e + ")", c.rows[d]), h, j, b = c.p.colModel[e], m = b.name, l = a.jgrid
												.jqID(m);
										switch (b.edittype) {
										case "select":
										...
										case "checkbox":
											var k = [ "Yes", "No" ];
											if (b.editoptions)
												k = b.editoptions.value
														.split(":");
											j = h = a("#" + d + "_" + l,
													c.rows[d]).attr("checked") ? k[0]
													: k[1];
											break;
										case "password":
										case "text":
										...
										case "custom":
											try {
												if (b.editoptions
														&& a
																.isFunction(b.editoptions.custom_value)) {
													h = b.editoptions.custom_value
															.call(
																	c,
																	a(
																			".customelement",
										...
										if (j !== c.p.savedRow[f].v) {
											...
											if (o[0] === true) {
												f = {};
												if (a
														.isFunction(c.p.beforeSubmitCell))
													(f = c.p.beforeSubmitCell
															.call(
																	c,
																	c.rows[d].id,
																	m, h, d, e))
																		...
																		.extend(
																				{
																					url : c.p.cellurl,
																					data : a
																							.isFunction(c.p.serializeCellData) ? c.p.serializeCellData
																							.call(
																									c,
																									v)
																							: v,
																					...
																					complete : function(
																						...
																						if (x == "success")
																							if (a
																									.isFunction(c.p.afterSubmitCell)) {
																								var A = c.p.afterSubmitCell
																										.call(
																												c,
																												s,
																												v.id,
																					...
																					error : function(
																						...
																						c.grid.hDiv.loading = false;
																						a
																								.isFunction(c.p.errorCell) ? c.p.errorCell
																								.call(
																										c,
																										s,
																										x)
									...
									a.browser.opera ? a("#" + c.p.knv).attr(
					...
					return this.each(function() {
						...
						if (!(!c.grid || c.p.cellEdit !== true)) {
							...
							if (f !== null) {
								...
								a(c).jqGrid("setCell", c.rows[d].id, e,
										c.p.savedRow[f].v, false, false, true);
								a.isFunction(c.p.afterRestoreCell)
										&& c.p.afterRestoreCell.call(c,
												c.rows[d].id,
												c.p.savedRow[f].v, d, e);
								c.p.savedRow.splice(0, 1)
							}
							window.setTimeout(function() {
					...
					return this
							.each(function() {
								...
								if (!(!this.grid || this.p.cellEdit !== true)) {
									for ( var f = e + 1; f < this.p.colModel.length; f++)
										if (this.p.colModel[f].editable === true) {
											c = f;
											break
										}
									if (c !== false)
										a(this).jqGrid("editCell", d, c, true);
									else
										this.p.savedRow.length > 0
												&& a(this).jqGrid("saveCell",
														d, e)
								}
							})
				},
				...
				GridNav : function() {
					return this
							.each(function() {
								function d(j, b, m) {
									if (m.substr(0, 1) == "v") {
										var l = a(c.grid.bDiv)[0].clientHeight, n = a(c.grid.bDiv)[0].scrollTop, k = c.rows[j].offsetTop
												+ c.rows[j].clientHeight, p = c.rows[j].offsetTop;
										if (m == "vd")
											if (k >= l)
									...
									if (m == "h") {
										...
										if (c.rows[j].cells[b].offsetLeft
												+ c.rows[j].cells[b].clientWidth >= m
												+ parseInt(l, 10))
											a(c.grid.bDiv)[0].scrollLeft = a(c.grid.bDiv)[0].scrollLeft
													+ c.rows[j].cells[b].clientWidth;
										else if (n < l)
											a(c.grid.bDiv)[0].scrollLeft = a(c.grid.bDiv)[0].scrollLeft
													- c.rows[j].cells[b].clientWidth
									}
								...
								function e(j, b) {
									...
									if (b == "rgt") {
										m = j - 1;
										for (l = j; l < c.p.colModel.length; l++)
											if (c.p.colModel[l].hidden !== true) {
												m = l;
												break
											}
			...
			.extend({
				setSubGrid : function() {
					return this.each(function() {
						...
						this.p.colModel.unshift({
							name : "subgrid",
							width : a.browser.safari ? this.p.subGridWidth
						...
						if (d[0]) {
							...
							for ( var e = 0; e < d[0].name.length; e++)
								...
								if (c.grid) {
									var f = function(q, r, s) {
										...
										for (x = 0; x < c.p.subGridModel[0].name.length; x++) {
											s = a("<th class='ui-state-default ui-th-subgrid ui-th-column ui-th-"
													+ c.p.direction + "'></th>");
											a(s)
													.html(
															c.p.subGridModel[0].name[x]);
											a(s)
													.width(
															c.p.subGridModel[0].width[x]);
											a(F).append(s)
										}
										a(B).append(F);
										if (q) {
													...
													.each(
															function() {
																...
																if (A.repeatitems === true)
																	...
																	var y = c.p.subGridModel[0].mapping
																			|| c.p.subGridModel[0].name;
																	if (y)
										...
										s = a("table:first", c.grid.bDiv).attr(
												"id")
												+ "_";
										a("#" + s + r).append(B);
										c.grid.hDiv.loading = false;
											...
											if (typeof s !== "undefined")
												for (x = 0; x < s.length; x++) {
													...
													if (B.repeatitems === true) {
														...
														var S = c.p.subGridModel[0].mapping
																|| c.p.subGridModel[0].name;
														if (S.length)
										...
										x = a("table:first", c.grid.bDiv).attr(
												"id")
												+ "_";
										a("#" + x + r).append(y);
										c.grid.hDiv.loading = false;
										...
										if (c.p.subGridModel[0].params)
											for (A = 0; A < c.p.subGridModel[0].params.length; A++)
												for (x = 0; x < c.p.colModel.length; x++)
													if (c.p.colModel[x].name == c.p.subGridModel[0].params[A])
														s[c.p.colModel[x].name] = a(
																"td:eq(" + x
																		+ ")",
																q)
																.text()
										...
										if (!c.grid.hDiv.loading) {
											...
											a("#load_" + c.p.id).show();
											if (!c.p.subgridtype)
												c.p.subgridtype = c.p.datatype;
											if (a.isFunction(c.p.subgridtype))
												c.p.subgridtype.call(c, s);
											else
												c.p.subgridtype = c.p.subgridtype
														.toLowerCase();
																...
																.extend(
																		{
																			...
																			data : a
																					.isFunction(c.p.serializeSubGridData) ? c.p.serializeSubGridData
																					.call(
																							c,
																							s)
																					: s,
														...
														.bind(
																...
																function() {
																	...
																	if (a(this)
																		...
																		m = c.p.id;
																		b = q.id;
																		if (c.p.subGridOptions.reloadOnExpand === true
																				|| c.p.subGridOptions.reloadOnExpand === false
																				&& !a(
																						p)
																						.hasClass(
																								"ui-subgrid")) {
																			...
																			k = true;
																			if (a
																					.isFunction(c.p.subGridBeforeExpand))
																			...
																			a
																					.isFunction(c.p.subGridRowExpanded) ? c.p.subGridRowExpanded
																					.call(
																							c,
																							m
																									+ "_"
																		...
																		a(this)
																				.html(
																						"<a href='javascript:void(0);'><span class='ui-icon "
																								+ c.p.subGridOptions.minusicon
																								+ "'></span></a>")
																				.removeClass(
																						"sgcollapsed")
																				.addClass(
																						"sgexpanded");
																		c.p.subGridOptions.selectOnExpand
																				&& a(
																						c)
																						.jqGrid(
																								"setSelection",
																		...
																		k = true;
																		if (a
																				.isFunction(c.p.subGridRowColapsed)) {
																			b = q.id;
																			k = c.p.subGridRowColapsed
																					.call(
																							c,
																							m
																									+ "_"
			...
			.extend({
					...
					return this
							.each(function() {
								...
								if (c.grid && c.p.treeGrid)
									for ( var f = c.p.expColInd, g = c.p.treeReader.expanded_field, h = c.p.treeReader.leaf_field, j = c.p.treeReader.level_field, b = c.p.treeReader.icon_field, m = c.p.treeReader.loaded, l, n, k, p; d < e;) {
										p = c.p.data[c.p._index[c.rows[d].id]];
										if (c.p.treeGridModel == "nested")
											if (!p[h]) {
												l = parseInt(
														p[c.p.treeReader.left_field],
														10);
												n = parseInt(
										...
										k = "<div class='tree-wrap tree-wrap-"
												+ c.p.direction
												+ "' style='width:" + k * 18
												+ "px;'>";
										k += "<div style='"
												+ (c.p.direction == "rtl" ? "right:"
														: "left:") + n * 18
												+ "px;' class='ui-icon ";
										if (p[m] !== undefined)
											p[m] = p[m] == "true"
										...
										p[g] = (p[g] == "true" || p[g] === true ? true
												: false)
												&& p[m];
										k += p[g] === true ? c.p.treeIcons.minus
												+ " tree-minus treeclick'"
												: c.p.treeIcons.plus
														+ " tree-plus treeclick'";
										k += "</div></div>";
										a(c.rows[d].cells[f]).wrapInner(
												"<span class='cell-wrapper" + n
														+ "'></span>").prepend(
												k);
										if (l !== parseInt(c.p.tree_root_level,
												10))
											(p = (p = a(c).jqGrid(
													"getNodeParent", p))
				...
				setTreeGrid : function() {
					return this.each(function() {
						...
						if (d.p.treeGrid) {
							...
							else if (d.p.treeGridModel == "adjacency")
								d.p.treeReader = a.extend({
									level_field : "level",
							...
							for (g in d.p.colModel)
								if (d.p.colModel.hasOwnProperty(g)) {
									...
									e++;
									for ( var j in d.p.treeReader)
										d.p.treeReader[j] == f && h.push(f)
								}
					...
					this
							.each(function() {
								if (this.grid && this.p.treeGrid)
									...
									case "nested":
										e = parseInt(
												d[this.p.treeReader.level_field],
												10)
												- parseInt(
										...
										break;
									case "adjacency":
										e = a(this).jqGrid("getNodeAncestors",
												d).length
									}
							});
					return e
					...
					this
							.each(function() {
								if (this.grid && this.p.treeGrid)
									switch (this.p.treeGridModel) {
									case "nested":
										var c = this.p.treeReader.left_field, f = this.p.treeReader.right_field, g = this.p.treeReader.level_field, h = parseInt(
												d[c], 10), j = parseInt(d[f],
												10), b = parseInt(d[g], 10);
										a(this.p.data)
												.each(
														function() {
															if (parseInt(
					...
					this
							.each(function() {
								...
								if (this.grid && this.p.treeGrid)
									switch (this.p.treeGridModel) {
									case "nested":
										var f = this.p.treeReader.left_field, g = this.p.treeReader.right_field, h = this.p.treeReader.level_field, j = parseInt(
												d[f], 10), b = parseInt(d[g],
												10), m = parseInt(d[h], 10);
										a(this.p.data)
												.each(
														function() {
															parseInt(this[h],
				...
				isVisibleNode : function(d) {
					...
					this
							.each(function() {
								if (this.grid && this.p.treeGrid) {
									var c = a(this).jqGrid("getNodeAncestors",
											d), f = this.p.treeReader.expanded_field;
									a(c).each(function() {
										e = e && this[f];
										if (!e)
											return false
					...
					this
							.each(function() {
								if (this.grid && this.p.treeGrid) {
									...
									e = d !== undefined ? d.loaded !== undefined ? d.loaded
											: d[c]
													|| a(this).jqGrid(
															"getNodeChildren",
															d).length > 0 ? true
					...
					return this
							.each(function() {
								if (this.grid && this.p.treeGrid) {
									...
									if (!d[e]) {
										var b = a.jgrid.getAccessor(d,
												this.p.localReader.id), m = a(
												"#" + b, this.grid.bDiv)[0], l = this.p._index[b];
				...
				collapseNode : function(d) {
					return this.each(function() {
						if (this.grid && this.p.treeGrid)
							if (d.expanded) {
								d.expanded = false;
								var e = a.jgrid.getAccessor(d,
										this.p.localReader.id);
								e = a("#" + e, this.grid.bDiv)[0];
								a("div.treeclick", e).removeClass(
					...
					return this.each(function() {
						if (this.grid && this.p.treeGrid) {
							...
							for (h = l.length; g < h; g++) {
								j = l[g];
								b.push(j);
								a(this).jqGrid("collectChildrenSortTree", b, j,
										d, e, c, f)
							}
							a.each(b, function(n) {
								var k = a.jgrid.getAccessor(this,
										m.p.localReader.id);
								a("#" + m.p.id + " tbody tr:eq(" + n + ")")
										.after(a("tr#" + k, m.grid.bDiv))
							});
							b = l = g = null
						}
					})
					...
					return this.each(function() {
						if (this.grid && this.p.treeGrid) {
							...
							for (b = l.length; j < b; j++) {
								m = l[j];
								d.push(m);
								a(this).jqGrid("collectChildrenSortTree", d, m,
										c, f, g, h)
							}
						}
					})
				...
				setTreeRow : function(d, e) {
					...
					this.each(function() {
						if (this.grid && this.p.treeGrid)
							c = a(this).jqGrid("setRowData", d, e)
					});
					return c
				},
							...
							.each(function() {
								...
								if (this.grid && this.p.treeGrid) {
									...
									if (b !== undefined) {
										...
										h = g - parseInt(this.p.data[b][c], 10)
												+ 1;
										b = a(this).jqGrid("getFullTreeNode",
												this.p.data[b]);
										if (b.length > 0)
											for ( var m = 0; m < b.length; m++)
												a(this).jqGrid("delRowData",
														b[m][e]);
										if (this.p.treeGridModel === "nested") {
											e = a.jgrid.from(this.p.data)
													.greater(c, g, {
														stype : "integer"
													}).select();
											if (e.length)
												for (j in e)
													e[j][c] = parseInt(e[j][c],
															10)
															- h;
											e = a.jgrid.from(this.p.data)
													.greater(f, g, {
					...
					if (c) {
						...
						if (e === undefined || e === null || e === "") {
							...
							if (q.length) {
								...
								q = a(f).jqGrid("getInd", e) + 1;
							if (o[h]) {
								s = true;
								o[g] = true;
								a(f.rows[x]).find("span.cell-wrapperleaf")
						...
						c[j] = v;
						c[h] = true;
						if (f.p.treeGridModel === "adjacency")
							c[b] = e;
						if (f.p.treeGridModel === "nested") {
							...
							if (e !== null) {
								...
								if (j.length)
									for (A in j) {
										j[A][m] = j[A][m] > h ? parseInt(
												j[A][m], 10) + 2 : j[A][m];
										j[A][l] = j[A][l] >= h ? parseInt(
												j[A][l], 10) + 2 : j[A][l]
									}
								c[m] = h;
								c[l] = h + 1
							} else {
								h = parseInt(a(f).jqGrid("getCol", l, false,
										"max"), 10);
								...
								if (j.length)
									for (A in j)
										j[A][m] = parseInt(j[A][m], 10) + 2;
								j = a.jgrid.from(f.p.data).greater(l, h, {
									stype : "integer"
								}).select();
								if (j.length)
									for (A in j)
										j[A][l] = parseInt(j[A][l], 10) + 2;
								c[m] = h + 1;
								c[l] = h + 2
							}
						}
	...
	a.jgrid
			.extend({
					...
					return this
							.each(function() {
								...
								if (d !== null
										&& (typeof d === "object" || a
												.isFunction(d)))
									if (d.groupField.length) {
										if (typeof d.visibiltyOnNextGrouping == "undefined")
										...
										for ( var e = 0; e < d.groupField.length; e++) {
											...
											d.groupText[e]
													|| (d.groupText[e] = "{0}");
											if (typeof d.groupColumnShow[e] != "boolean")
												d.groupColumnShow[e] = true;
											if (typeof d.groupSummary[e] != "boolean")
												d.groupSummary[e] = false;
											if (d.groupColumnShow[e] === true) {
												d.visibiltyOnNextGrouping[e] = true;
												a(this).jqGrid("showCol",
														d.groupField[e])
											} else {
											...
											if (d.groupSummary[e]) {
												d.summary[e] = [];
												for ( var c = this.p.colModel, f = 0, g = c.length; f < g; f++)
													c[f].summaryType
															&& d.summary[e]
																	.push({
																		nm : c[f].name,
					...
					this
							.each(function() {
								...
								if (c.hasOwnProperty(g))
									...
									h.sortnames[0]
											.push(a.trim(e[0].toString()));
									h.summaryval[0][g] = a.extend(true, [],
											h.summary[0])
								}
								h.groupSummary[0]
										&& a
				...
				groupingToggle : function(d) {
					this
							.each(function() {
								var e = this.p.groupingView, c = d
										.lastIndexOf("_"), f = d.substring(0,
										c + 1);
								c = parseInt(d.substring(c + 1), 10) + 1;
								var g = e.minusicon, h = e.plusicon, j = a("#"
										+ d)[0].nextSibling, b = a("#" + d
										+ " span.tree-wrap-" + this.p.direction), m = false;
								if (b.hasClass(g)) {
									if (e.showSummaryOnHide
											&& e.groupSummary[0]) {
										if (j)
											for (; j;) {
												if (a(j).hasClass("jqfoot"))
													break;
												a(j).hide();
												j = j.nextSibling
											}
								...
								a.isFunction(this.p.onClickGroup)
										&& this.p.onClickGroup.call(this, d, m)
							});
					return false
				},
				...
				groupingGroupBy : function(d, e) {
					return this.each(function() {
						...
						for ( var f = 0; f < c.groupField.length; f++)
							!c.groupColumnShow[f]
									&& c.visibiltyOnNextGrouping[f]
									&& a(this).jqGrid("showCol",
											c.groupField[f]);
						for (f = 0; f < d.length; f++)
							c.visibiltyOnNextGrouping[f] = a(
									"#" + this.p.id + "_" + d[f])
									.is(":visible");
				...
				groupingRemove : function(d) {
					return this
							.each(function() {
								...
								this.p.grouping = false;
								if (d === true) {
									for ( var e = this.p.groupingView, c = 0; c < e.groupField.length; c++)
										!e.groupColumnShow[c]
												&& e.visibiltyOnNextGrouping[c]
												&& a(this).jqGrid("showCol",
														e.groupField);
					...
					return this
							.each(function() {
								var e = this, c = function(h, j) {
									var b = a(j.xmlGrid.config, h)[0], m = a(
											j.xmlGrid.data, h)[0], l;
								...
								case "xmlstring":
									if (d.impstring
											&& typeof d.impstring == "string") {
										var g = a.jgrid
												.stringToDoc(d.impstring);
										if (g) {
											c(g, d);
											a.isFunction(d.importComplete)
													&& d.importComplete(g);
					...
					return this
							.each(function() {
								...
								g = {
									...
									axis : "x",
									scrollSensitivity : "1",
									items : ">th:not(:has(#jqgh_" + g
											+ "_cb,#jqgh_" + g + "_rn,#jqgh_"
											+ g + "_subgrid),:hidden)",
									placeholder : {
										element : function(j) {
											return a(
													document
															.createElement(j[0].nodeName))
													.addClass(
															j[0].className
									...
									update : function(j, b) {
										...
										var k = [];
										m.each(function() {
											var p = a(">div", this).get(0).id
													.replace(/^jqgh_/, "")
													.replace(n, "");
											p in l && k.push(l[p])
										});
										a(f).jqGrid("remapColumns", k, true,
												true);
										a.isFunction(f.p.sortable.update)
												&& f.p.sortable.update(k);
										setTimeout(function() {
											f.p.disableClick = false
										}, 50)
									}
								};
								if (f.p.sortable.options)
									a.extend(g, f.p.sortable.options);
								else if (a.isFunction(f.p.sortable))
									f.p.sortable = {
										update : f.p.sortable
									};
								if (g.start) {
									...
									g.start = c;
								if (f.p.sortable.exclude)
									g.items += ":not(" + f.p.sortable.exclude
											+ ")";
				...
				columnChooser : function(e) {
					function c(k, p) {
						if (k)
							if (typeof k == "string")
								a.fn[k]
										&& a.fn[k].apply(p, a.makeArray(
												arguments).slice(2));
							else
								a.isFunction(k)
										&& k.apply(p, a.makeArray(arguments)
												.slice(2))
					}
					var f = this;
					if (!a("#colchooser_" + f[0].p.id).length) {
						var g = a('<div id="colchooser_'
								+ f[0].p.id
								+ '" style="position:relative;overflow:hidden"><div><select multiple="multiple"></select></div></div>'), h = a(
								"select", g);
						e = a.extend({
							width : 420,
							height : 240,
							...
							dlog_opts : function(k) {
								...
								return {
									...
									resizable : k.resizable ? k.resizable
											: true,
									width : k.width + 20
								}
							},
							apply_perm : function() {
								a("option", h).each(
										function() {
											this.selected ? f.jqGrid("showCol",
													j[this.value].name) : f
													.jqGrid("hideCol",
															j[this.value].name)
										});
								...
								a.each(m, function() {
									...
									var o = k, v = p;
									if (v >= 0) {
										var q = o.slice(), r = q.splice(v, Math
												.max(o.length - v, v));
										if (v > o.length)
											v = o.length;
										q[v] = p;
						...
						var j = f.jqGrid("getGridParam", "colModel"), b = f
								.jqGrid("getGridParam", "colNames"), m = {}, l = [];
						h.empty();
						a.each(j, function(k) {
							m[this.name] = k;
							if (this.hidedlg)
								this.hidden || l.push(k);
							else
						...
						var n = a.isFunction(e.dlog_opts) ? e.dlog_opts.call(f,
								e) : e.dlog_opts;
						c(e.dlog, g, n);
						n = a.isFunction(e.msel_opts) ? e.msel_opts.call(f, e)
								: e.msel_opts;
						c(e.msel, h, n)
					}
				},
								...
								if (c.grid)
									if (!c.p.treeGrid)
										if (a.fn.sortable) {
											...
											if (e.start
													&& a.isFunction(e.start)) {
												e._start_ = e.start;
												delete e.start
											} else
												e._start_ = false;
											if (e.update
													&& a.isFunction(e.update)) {
												e._update_ = e.update;
												delete e.update
											} else
												e._update_ = false;
				...
				gridDnD : function(e) {
					return this
							.each(function() {
								function c() {
									var h = a.data(f, "dnd");
									a("tr.jqgrow:not(.ui-draggable)", f)
											.draggable(
													a.isFunction(h.drag) ? h.drag
															.call(a(f), h)
															: h.drag)
								}
								var f = this;
											...
											if (typeof e == "string"
																							...
																							start : function(
																								...
																								a(
																										...
																										.each(
																												function(
																														n) {
																													this.style.width = f.grid.headers[n].width
																															+ "px"
																												});
																								h.onstart
																										&& a
																												.isFunction(h.onstart)
																										&& h.onstart
																												.call(
																														a(f),
																														j,
												...
												if (e.connectWith) {
													...
													f.p.reccount != "0"
															...
															&& c();
													f.p.jqgdnd = true;
													for ( var g = 0; g < e.connectWith.length; g++)
														a(e.connectWith[g])
																.droppable(
																		a
																				.isFunction(e.drop) ? e.drop
																				.call(
																						a(f),
																						e)
																				: e.drop)
							...
							.each(function() {
								...
								if (c.grid && a.fn.resizable) {
									...
									e.stop = function(f, g) {
										...
										a(c).jqGrid("setGridWidth",
												g.size.width, e.shrinkToFit);
										e._stop_ && e._stop_.call(c, f, g)
									};
									e.alsoResize = e._alsoResize_ ? eval("("
											+ ("{'#gview_"
													+ c.p.id
													+ " .ui-jqgrid-bdiv':true,'"
													+ e._alsoResize_ + "':true}")
			...
			.each(
					function() {
						if (!this.grid) {
							...
							var e = jQuery(this).width(), c = jQuery(
									"input[type=checkbox]:first", jQuery(this)), f = jQuery(
							...
							for (e = 0; e < l.length; e++)
								jQuery(this).jqGrid("setSelection", l[e])
						}
					})
};
